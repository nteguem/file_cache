...
<?php $contextdispo_v4 = filemtime(PATH_ASSETS.'css/jquery.contextmenu.css') ?>
  <link rel="stylesheet" type="text/css" href="css/jquery.contextmenu.<?php echo $contextdispo_v4 ?>.css">

  <?php $treeViewdispo_v4 = filemtime(PATH_ASSETS.'css/bootstrap-treeview.css') ?>
  <link rel="stylesheet" type="text/css" href="css/bootstrap-treeview.<?php echo $treeViewdispo_v4 ?>.css">
...
div.agenda_v4 div.fc-view-container div.fc-view table tbody.fc-body tr td.fc-widget-content div.fc-time-grid-container{
...
.vd_head-section, .vd_title-section {
    padding: 1px !important;
}
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="panel widget light-widget">
        <div class="panel-body" style="padding:2px 15px 0!important">

          <div class="btn_param no-print" style="height: 53px;position:fixed; top:65px!important;" id="tpl_agenda_horizontale">
           ...
           {* <a href="#" onclick="$('#myModalfiltremedecin').modal('show');" alt="Sélectionner le planning à afficher" title="Sélectionner le planning à afficher"><img src="img/logo_afficher_agenda.gif" border="0" height="40px" /></a>
            ...
            <ul id="ulcalendar" class="nav nav-tabs nav-justified no-print">
              {foreach from=$tabPraticien item=tabP name=sTabPraticien}
                ...
                {if $tabPraticien|@count > 1 && $smarty.foreach.sTabPraticien.iteration == $tabPraticien|@count}
                  <li >                  
                    <div title="Configuration" data-placement="bottom" class="width-sm-1" style="position:absolute;z-index:40;margin-left:10px;margin-top:10px;cursor:pointer;">
                      {include file="modal_statut_tous.tpl"}
                    <div>
                      <button type="button" style="position:absolute;z-index:40;cursor:pointer;background-color:transparent; border:none;"
                      data-toggle="modal" data-target="#modal_tous">
                      {* Fichier : modal_statut_tous.tpl pour avoir le template de la modale. *}
                      {* <button type="button" onclick="open_modal_tous();" style="position:absolute;z-index:40;cursor:pointer;background-color:transparent; border:none;"> *}
                          <span class="mega-icon">
                            <i class="fa fa-cog"></i> 
                          </span>
                      </button>
                    ...
                    <a href="#taball" sidtab="all" data-toggle="tab">
                      <h4><b>Tous</b></h4>
                    </a>
                  </li>
            ...
            {foreach from=$tabPraticien item=tabP2 name=sTabPraticien2}
              ...
              <div class="tab-pane {if $smarty.foreach.sTabPraticien2.iteration==1}active{/if}" id="tab{$tabP2.id_user}">
                 ...
                 $(document).ready(function() {
                   ...
                   $('#calendar_{/literal}{$tabP2.id_user}{literal}').fullCalendar({
                    ...
                    eventClick: function(calEvent, jsEvent, view) {
                      ...
                      if (calEvent.idrdv!=0) {
                        if (calEvent.dispo=="") {
                          enreg_planning(calEvent.title,calEvent.id,start,starth,calEvent.idrdv,end,endh,calEvent.nomdocteur,calEvent.iddocteur,calEvent.idlieu,calEvent.typerdvaff,calEvent.id,{/literal}{$tabP2.id_user}{literal}, '{/literal}{$tabP2.identifiant_user}{literal}',calEvent.idrdvaide,calEvent.idplanning);
                                ...
                                if(true)
                                {
                                  ...
                                  if(tmpEntete.indexOf("<!-- separator2 -->")<0){
                                    ...
                                    if(!isNaN(idgenererfinal)){
                                      ...
                                      $("#calendar_"+{/literal}{$tabP2.id_user}{literal}+' .fc-widget-header .fc-'+sJourSemaine).html(sscript+icone+divconsigne+"<!-- separator -->"+thedate+'<!-- separator2 --> <br><span style="font-size:12px;">M: <b><span id="nbRdvMatin'+sJourSemaine + '{/literal}{$tabP2.id_user}{literal}" style="color:green;">'+sNbMatin+' RDV</span></b> - A.M: <b><span id="nbRdvAM'+sJourSemaine + '{/literal}{$tabP2.id_user}{literal}"  style="color:red;">'+sNbSoir+' RDV</span></b> - '+sOccupation+'%</span>');
                                    }
                                  
                                  }else{
                                    $("#nbRdvMatin" + sJourSemaine + "{/literal}{$tabP2.id_user}{literal}").text(sNbMatin + ' RDV');
                                    $("#nbRdvAM" + sJourSemaine + "{/literal}{$tabP2.id_user}{literal}").text(sNbSoir + ' RDV');
                                  }
                                }
                              }
                ...
                function persoEventAfterRender(event, element, view) {
                  ...
                  if((typeof event.idrdv !== 'undefined') && (event.idrdv != 0) && (event.etatrdv != "suppression_groupe")){
                    var menu1 = [
                      ...
                      {'Imprimer le RDV': {
                          onclick:function(menuItem,menu) {
                              window.open('print_rdv.php?idrdv='+event.idrdv,'_blank');
                              $(".menu_custom_alaxione").hide();
                              return true;
                          },
                    ...
                    element.bind('mousedown', function (e) {
                        if (e.which == 3) {
                            ...
                            $(".menu_custom_alaxione").hide();
                            $(".menu_custom_alaxione").css('position', 'absolute');
                            $(".menu_custom_alaxione").css({left:e.pageX, top:e.pageY});
                ...
                <div id="calendar_{$tabP2.id_user}" class="mgtp-10 agenda_v4"> </div>
                </div>
              </div>
            {/foreach}
                ...
                <script type="text/javascript">
                 $(document).ready(function() {
                  ...
                  $('#calendar_all').fullCalendar({
                    ...
                    editable: false,       //calendrier modifiable
                    weekNumbers: true,      //on affiche le num de semaine
                    scrollTime: "{/literal}{$heureagendedebutdefaut}{literal}",   //le scroll débute à 7h
                    minTime: "{/literal}{$heureagendedebutdefaut}{literal}",    //le calendar demarre à 7h
                    maxTime: "{/literal}{$heureagendefindefaut}{literal}",    //le calendar fini à 20h
                    slotEventOverlap: false,  //les event ne se chevoche pas
                    defaultView: 'agendaDay',  //afficher la semaine par defaut
                    defaultDate: moment($('#datedebutaff_all').val()).format('YYYY-MM-DD'),
                    slotLabelFormat: 'H:mm',
                    slotLabelInterval: '00:'+{/literal}{$pasagendadefautpas}{literal},
                    slotDuration: '00:'+{/literal}{$pasagendadefautpas}{literal}+':00',
                    allDaySlot: false,    //ne pas afficher la ligne "Toute la journée"
                    //allDayText: 'Memo',
                    resources: [
...
function enreg_planning(nompatient,idrdv,daterdv,heurerdv,idrdv,daterdvfin,heurefin,nomdocteur,iddocteur,idlieu,idtyperdv,jsEvent,idcalendar,identifiant_praticien,idaider,idplanning){
    ...
    $.ajax({
        ...
        success: function(json) {
          $.each(json, function(index, value) {
            ...
            get_new_rendez_vous(identifiant_praticien, daterdv, heurerdv, idlieu, idtyperdv,idaider,idplanning);
...
function rafraichir_calendrier(idlieu,idpratcien,idrdv,validation,datedebut,firstrdvdispo, reinit){
  ...
  /*function open_modal_tous(){
    $('#modal_tous').modal('show');
  }
*/
...
c
    ...
    function scroll_calendar_page(){
      ...
      if ($(window).scrollTop() > 0) {
        ...
        ulcalendarTop = headerHeight + 40;
        //ulcalendarTop = headerHeight + btnparamHeight;
        ...
        fctoolbarTop = btnparamHeight + ulcalendarHeight+44;
        //fctoolbarTop = headerHeight + btnparamHeight + ulcalendarHeight;
        ...
        fcheadTop = btnparamHeight + ulcalendarHeight + fctoolbarHeight +54;
        //fcheadTop = headerHeight + btnparamHeight + ulcalendarHeight + fctoolbarHeight;
