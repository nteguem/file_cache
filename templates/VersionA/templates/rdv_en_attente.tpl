                                ...
                                {if isset($objRech.type_champ) and ((isset($objRech.aff_recherche) and $objRech.aff_recherche eq 'ok') or ($objRech.type_champ eq 'category' or $objRech.type_champ eq 'bouton'))}
                                    ...
                                    {elseif $objRech.type_champ eq 'date'}
                                        ...
                                        {else}
                                            ...
                                            {literal}
                                            <?php $datepicker2 = filemtime(PATH_ASSETS . 'js/datepicker-fr.js') ?>
                    ...
                    <div class="panel-body-list table-responsive">
                            ...
                            {foreach from=$aListe item=objListe}
                                <tr>
                                    {if $bActiveFormSelect or $bRadioSelect or $bCheckboxSelect}
                                        ...
                                        {if $bCheckboxSelect}<td class="center"><input type="checkbox" value="{$objListe.id}" name="iIdChecked[]"></td>{/if}
                                    {/if}
                        ...
                        {if $bActiveFormSelect   or $bRadioSelect or $bCheckboxSelect}
                            <div style="clear:both;float:left;margin-top:20px;">
                                <input type="hidden" name="validation_initier" value="ok">
                                {*<input type="submit" value="Intier " style="background-color:#94B52C;border:1px solid #719C27;border-radius:8px;padding:7px 16px;font-size:11px;color:#FFF;cursor:pointer;">*}
                                <button type="submit" name="btninitierrdvpatient" id="btninitierrdvpatient" class="btn vd_btn" style="margin-top:5px;background-color: #f89c2c;">Initier un RDV pour le patient</button>
