...
<div class="vd_title-section clearfix">
  <div class="vd_panel-header no-menu">
    <h1>{$titreagenda}</h1>
    <small class="subtitle">Gérer votre prise de Rendez-Vous</small> </div>
</div>
          ...
          <div id="external-events">
            ...
            <div class="form-group">
               ...
               <label class="col-sm-2 control-label">Date</label>
                  <div class="input-group">
                  <input type="text" name="datefiltre" >
                  <span class="input-group-addon" id="datepicker-icon-trigger" data-datepicker="#id_filtre">
              ...
              {literal}
                        ...
                        $(document).ready(function() {
                          $( "#id_filtre" ).datepicker({ dateFormat: 'dd/mm/yy'});
