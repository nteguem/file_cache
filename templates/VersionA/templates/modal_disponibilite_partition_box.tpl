...
<head>
  ...
  <meta HTTP-EQUIV="pragma" CONTENT="NO-CACHE">
    ...
    <link href="css/bootstrap.min.{$boostrapK}.css" rel="stylesheet" type="text/css">
    <link href="css/font-awesome.min.{$awesomeK}.css" rel="stylesheet" type="text/css">
    <!--[if IE 7]><link type="text/css" rel="stylesheet" href="css/font-awesome-ie7.min.css"><![endif]-->
    <link href="css/font-entypo.{$fontEntypo}.css" rel="stylesheet" type="text/css">    

    <!-- Fonts CSS -->
    <link href="css/fonts.{$fontK}.css"  rel="stylesheet" type="text/css">
               
    <!-- Plugin CSS -->
    <link href="plugins/jquery-ui/jquery-ui.custom.min.{$customMink}.css" rel="stylesheet" type="text/css">    
    <link href="plugins/prettyPhoto-plugin/css/prettyPhoto.{$prettyK}.css" rel="stylesheet" type="text/css">
    <link href="plugins/isotope/css/isotope.{$isotopeK}.css" rel="stylesheet" type="text/css">
    <link href="plugins/pnotify/css/jquery.pnotify.{$pnotifyK}.css" media="screen" rel="stylesheet" type="text/css">    
  <link href="plugins/google-code-prettify/prettify.{$prettifyK}.css" rel="stylesheet" type="text/css"> 
   
         
    <link href="plugins/mCustomScrollbar/jquery.mCustomScrollbar.{$srcollbarrK}.css" rel="stylesheet" type="text/css">
    <link href="plugins/tagsInput/jquery.tagsinput.{$tagsinputK}.css" rel="stylesheet" type="text/css">
    <link href="plugins/bootstrap-switch/bootstrap-switch.{$switchK}.css" rel="stylesheet" type="text/css">    
    <link href="plugins/daterangepicker/daterangepicker-bs3.{$daterangerpickerK}.css" rel="stylesheet" type="text/css">    
    <link href="plugins/bootstrap-timepicker/bootstrap-timepicker.min.{$timepickerK}.css" rel="stylesheet" type="text/css">
    <link href="plugins/colorpicker/css/colorpicker.{$colorpickerK}.css" rel="stylesheet" type="text/css">


    <!-- Theme CSS -->
    <link href="css/theme.min.{$themek}.css" rel="stylesheet" type="text/css">
    <!--[if IE]> <link href="css/ie.css" rel="stylesheet" > <![endif]-->
    <link href="css/chrome.{$chromeK}.css" rel="stylesheet" type="text/chrome"> <!-- chrome only css -->    


        
    <!-- Responsive CSS -->
          <link href="css/theme-responsive.min.{$responsiveK}.css" rel="stylesheet" type="text/css"> 
    ...
    <!-- Custom CSS -->
    <link href="custom/custom.{$customK}.css" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src='plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.{$bootstrapWizard2}.js'></script>
    ...
    <script type="text/javascript" src='plugins/ckeditor/adapters/jquery.{$ckeditorQuery2}.js'></script>
                ...
                <div class="panel widget">
                  <h2>{$stitreplanningpere}</h2>
                    <div class="panel-body">
                      ...
                      <input type="hidden" name="id_box" id="id_box" value="{$id_box}" />
                      ...
                      <input type="hidden" name="idtranchesup" id="idtranchesup" value="{$idtranchesup}" />
                            ...
                            <div>
                              <div class="vd_checkbox checkbox-success">
                                ...
                                {foreach from=$aTableauTyperdv item=objTyperdv}
                                  ...
                                  <input class="class_checkAll_dispo" id="checkbox-{$objTyperdv.id}" type="checkbox"  name="typerdv[]" value="{$objTyperdv.id}"
                      ...
                      <div class="form-group" id="divheurejour">
                        <div class="col-sm-3 controls">
                          <div class="input-group">
                            ...
                            <input type="text" id="heuredebut" name="heuredebut" value="{$heuredebut}" class="required input-modal" required>
                          </div>
                          {*<div  id="divdatedebut">
                        ...
                        <div class="col-sm-3 controls">
                          <div class="input-group">
                            ...
                            <input type="text" id="heurefin" name="heurefin" value="{$heurefin}" class="required input-modal" required>
                          </div>
                          {*<div id="divdatefin">
                      ...
                      <div class="col-sm-12 controls" id="divperiode" align="center">
                         <button id="btn_update" name="btn_update" value="1" type="submit" class="btn vd_btn vd_bg-green" onclick="$('#btn_plus_rdv_modal_calendar').prop('disabled', true);">{if $idtranchesup!="" }Modifier {else} Ajouter{/if}</button>
