...
{literal}
    ...
    <![endif]-->
    <script type="text/javascript" src='plugins/fullcalendar-3.5.0/lib/jquery.min.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    ...
    <script type="text/javascript" src='plugins/jquery-ui/jquery-ui.custom.min.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    <script type="text/javascript" src="plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    ...
    <script type="text/javascript" src="js/jquery.autocomplete.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/breakpoints/breakpoints.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/dataTables/jquery.dataTables.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/tagsInput/jquery.tagsinput.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/bootstrap-switch/bootstrap-switch.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/blockUI/jquery.blockUI.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/pnotify/js/jquery.pnotify.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    ...
    <script type="text/javascript" src='plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    <script type="text/javascript" src="plugins/dataTables/jquery.dataTables.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/dataTables/dataTables.bootstrap.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src='plugins/bootstrap-timepicker/bootstrap-timepicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    ...
    <script type="text/javascript" src='plugins/colorpicker/colorpicker.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/load-image.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/jquery.iframe-transport.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/jquery.fileupload.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/jquery.fileupload-process.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/jquery.fileupload-image.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/jquery.fileupload-audio.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="plugins/jquery-file-upload/js/jquery.fileupload-validate.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src='plugins/fullcalendar-3.5.0/lib/jquery-ui.min.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    <script type="text/javascript" src='plugins/fullcalendar-3.5.0/lib/moment.min.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    ...
    <script type="text/javascript" src='plugins/ckeditor/ckeditor.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    <script type="text/javascript" src='plugins/ckeditor/adapters/jquery.js?v={/literal}{$numero_version_alaxione}{literal}'></script>
    <script type="text/javascript" src="js/jquery.maskedinput.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/maskchamps.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/bootstrap-clockpicker.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/jquery-clockpicker.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/isotope.pkgd.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/inputmask.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/jquery.inputmask.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    <script type="text/javascript" src="js/intlTelInput.min.js?v={/literal}{$numero_version_alaxione}{literal}"></script>
    ...
    <script type="text/javascript">
        ...
        if (!!window.EventSource) {
            ...
            alert("Votre navigateur ne supporte pas la technologie de rafraichissement automatique (Server Sent Events), veuillez utiliser le navigateur Google Chrome.");
        }
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                {/if}
                     <div id="div_interpro_valider_cgu" class="row" style="margin:0px;margin-bottom:10px;padding:0px;">
...
<div class="modal fade" id="myModalHome" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 100%!important;">
        ...
        <div class="vd_panel-menu left-pos {if $bIsMobile}visible{else}hidden{/if}" style="position: fixed !important;">
          ...
          <div class="vd_container {if $bIsMobile}hidden{/if}">
          	<div class="row ">
                ...
                {/if}
                <div class="{if $iAccess == "10" || $sGroupe == 'secrelimite'}col-sm-5{else}col-sm-7{/if} col-xs-12">
                ...
                <div class="col-sm-5 col-xs-12">
              		<div class="vd_mega-menu-wrapper">
                    	<div class="vd_mega-menu pull-right">
            				<ul class="mega-ul">
                                {if $bisAlaxioneMaitreModuleExterne!=false}
                                ...
                                {/if}
                                {if $smsRetourVisible=="Y" && $iAccess == "10"}
                                ...
                                {if $idinterpro=="" || $idinterpro=="0" && $iAccess == "10"}
                                                        ...
                                                        <div class="mCSB_container" style="position: relative; top: 0px;">
                                                            <ul class="list-wrapper  pd-lr-10">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a href="#" onclick="get_fiche_rendez_vous({$objRDV.id_prise_rendez_vous}); $('#modalFicheRendezVous').modal('show');$('#info_rdv_modal_link').click();">
                                        ...
                                        <div class="child-menu">
                                            <div class="content-list content-menu">
                                                <ul class="list-wrapper pd-lr-10">
                                                    ...
                                                    {/if}
                                                    <li> <a href="javascript:void(0);" onclick="info_support();"> <div class="menu-icon"><i class="fa fa-info"></i></div> <div class="menu-text">Obtenir de l'aide</div> </a> </li>
...
<!-- Head menu search form ends -->                         
    ...
    <div class="content">
        <div class="container">
            ...
            {/if}
            <div class="vd_navbar vd_nav-width vd_navbar-tabs-profile vd_navbar-left no-print {if $bIsMobile}visible{else}hidden{/if}" style="z-index:999;">
                {include file="menu_mobile.tpl"}
            </div>

            <!-- début salle d'attente -->
            <div id="divsalleattente" class="vd_navbar vd_nav-width vd_navbar-tabs-menu vd_bg-black-80 vd_navbar-right {if $bIsMobile}hidden{/if}">
...
<div style="overflow-x: hidden;overflow-y: auto;z-index:2000;" class="modal fade in" id="modalFichePatient" tabindex="-1" role="dialog" aria-labelledby="LabelmodalFichePatient" aria-hidden="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <div>
                    ...
                    <h3>FICHE PATIENT : <span id='span_cnp' name='span_cnp'></span></h3>

                    <div class="tabs">
                        <ul class="nav nav-tabs widget vd_bg-color">
                            <li class="active"> <a href="#info-tab" data-toggle="tab"> <span class="menu-icon"><i class="fa fa-user"></i></span>Informations<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            <li> <a href="#histo-tab" data-toggle="tab" onclick="getHistoPatient();"> <span class="menu-icon"><i class="fa fa-history"></i></span>Historique<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            {if $bloquerInterpro == 'N'}
                                <li> <a href="#profil-tab" data-toggle="tab" onclick="getprofilPatient();"> <span class="menu-icon"><i class="fa fa-history"></i></span>RDV Profilé<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            {/if}
                            {if $bActifPlantraitement && $bloquerInterpro == 'N'}
                                <li> <a href="#plan-traitement-tab" data-toggle="tab" onclick="getplanTraitmentPatient();"> <span class="menu-icon"><i class="fa fa-list-ol"></i></span>Plan de traitement<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            {/if}
                            <li> <a href="#doc-tab" data-toggle="tab" onclick="getDocumentPatient();"> <span class="menu-icon"><i class="fa fa-files-o"></i></span>Documents<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            <li> <a href="#famille-tab" data-toggle="tab" onclick="getFamillePatient();"> <span class="menu-icon"><i class="fa fa-user"></i></span>Comptes liés<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            {if $bactivvisuhistopatient}
                                <li> <a href="#log-patient" data-toggle="tab" onclick="getLogPatient($('#id_fiche_patient').val());"> <span class="menu-icon"><i class="fa fa-history"></i></span> Historique de gestion<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            {/if}
                            {if $bActifSurvey && in_array('voiravispatients',$tabdroituser)}
                                <li> <a href="#avis-tab" data-toggle="tab" onclick="getAvisPatients($('#id_fiche_patient').val(), '{$iddebug_user}', '{$token_user}', '{$sDomaine}', '{$sLinkAlaxioneSurvey}');"> <span class="menu-icon"><i class="ico-avis-patient"></i></span> Avis patient<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                            {/if}
                        </ul>
                        <div class="tab-content mgbt-xs-20">
                            <div class="tab-pane active col-sm-12" id="info-tab">
                                <div id="message_retour_info_fiche_patient" style="margin-top:15px; display: none;"></div>
                                ...
                                <div id="div_info_patient" style="display: none;">
                                    <form action="" role="form" id="modal_fiche_patient" class="form-horizontal">
                                        ...
                                        <input type="hidden" name="id_fiche_patient" id="id_fiche_patient" value="" />
                                        ...
                                        <input type="hidden" name="ab_civilite_fiche_patient" id="ab_civilite_fiche_patient" value="" />
                                        ...
                                        <div class="form-group" style="margin-top: 15px">
                                            <div class="col-sm-3 controls">
                                                <div class="vd_input-wrapper-modal" style="background-color:#fff;">
                                                    <select id="civilite_fiche_patient" name="civilite_fiche_patient" required onchange="civiliteNomJeuneFille(this.options[this.selectedIndex].text,'divnomjeunefille_fiche_patient');" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if}>
                                            ...
                                            <div class="col-sm-5 controls">
                                                <input type="text" placeholder="Nom" name="nom_fiche_patient" id="nom_fiche_patient" value="" required class="required input-majuscule" {if $iAccess != '10' && $iAccess!='5'}disabled{/if} />
                                            </div>
                                            <div class="col-sm-4 controls">
                                                <input type="text" placeholder="Prénom" name="prenom_fiche_patient" id="prenom_fiche_patient" value="" required class="input-first-letter"  {if $iAccess != '10' && $iAccess!='5'}disabled{/if}/>
                                            </div>
                                        </div>
                                        <div class="form-group" id='divnomjeunefille_fiche_patient' style='display:none;'>
                                            <div class="col-sm-12 controls">
                                                <input type="text" placeholder="Nom de naissance" name="nom_fille_fiche_patient" id="nom_fille_fiche_patient" value="" class="input-majuscule" {if $iAccess != '10' && $iAccess!='5'}disabled{/if}/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12 controls">
                                                <input type="text" placeholder="Adresse" name="adresse_fiche_patient" id="adresse_fiche_patient" value="" {if $iAccess != '10' && $iAccess!='5'}disabled{/if} />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-6 controls">
                                                <input type="text" placeholder="Code postal" name="code_postal_fiche_patient" id="code_postal_fiche_patient" value="" {if $iAccess != '10' && $iAccess!='5'}disabled{/if} />
                                            </div>
                                            <div class="col-sm-6 controls">
                                                <input type="text" placeholder="Ville" name="ville_fiche_patient" id="ville_fiche_patient" value="" {if $iAccess != '10' && $iAccess!='5'}disabled{/if}/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-6 controls">
                                                <input type="hidden" name="tel_mobile_fiche_patient_indicatif" id="tel_mobile_fiche_patient_indicatif" value="{$num_indicatif_structure}" />
                                                <input type="text" placeholder="Téléphone mobile" name="tel_mobile_fiche_patient" id="tel_mobile_fiche_patient" value="" {if $iAccess != '10' && $iAccess!='5'}disabled{/if} />
                                                {literal}
                                                    <script type="text/javascript">
                                                        $(document).ready(function () {
                                                            ...
                                                            }else if($("#tel_mobile_fiche_patient_indicatif").val() === "33"){
                                                                $("#tel_mobile_fiche_patient").inputmask("99 99 99 99 99");
                                                            }

                                                            $("#tel_mobile_fiche_patient").on("keyup change", function() {
                                                                var countryData = $("#tel_mobile_fiche_patient").intlTelInput("getSelectedCountryData");
                                                                $("#tel_mobile_fiche_patient_indicatif").val(countryData.dialCode);
                                                            });

                                                            $("#tel_mobile_fiche_patient").on("countrychange", function(e, countryData) {
                                                                $("#tel_mobile_fiche_patient_indicatif").val(countryData.dialCode);
                                            ...
                                            <div class="col-sm-6 controls">
                                                <input type="hidden" name="tel_fixe_fiche_patient_indicatif" id="tel_fixe_fiche_patient_indicatif" value="{$num_indicatif_structure}">
                                                <input type="text" placeholder="Téléphone fixe" name="tel_fixe_fiche_patient" id="tel_fixe_fiche_patient" value="" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if} />
                                                {literal}
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        ...
                                                        }else if($("#tel_fixe_fiche_patient_indicatif").val() === "33"){
                                                            $("#tel_fixe_fiche_patient").inputmask("99 99 99 99 99");
                                                        }

                                                        $("#tel_fixe_fiche_patient").on("keyup change", function() {
                                                            var countryData = $("#tel_fixe_fiche_patient").intlTelInput("getSelectedCountryData");
                                                            $("#tel_fixe_fiche_patient_indicatif").val(countryData.dialCode);
                                                        });

                                                        $("#tel_fixe_fiche_patient").on("countrychange", function(e, countryData) {
                                                            $("#tel_fixe_fiche_patient_indicatif").val(countryData.dialCode);
                                                            var idpays = countryData.iso2;
                                                            if(idpays === "fr"){
                                                                $("#tel_fixe_fiche_patient").inputmask("99 99 99 99 99");
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 controls">
                                                <input type="email" placeholder="Email" name="email_fiche_patient" id="email_fiche_patient" value="" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if} />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-4 controls">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Date de naissance" name="date_naissance_fiche_patient" id="date_naissance_fiche_patient" value="" class="required" required {if $iAccess != '10'  && $iAccess!='5'}disabled{/if} />
                                                    <span class="input-group-addon" id="datepicker-icon-trigger" data-datepicker="#date_naissance_fiche_patient">
                                                      <i class="fa fa-calendar"></i>
                                                    </span>
                                                </div>
                                                <div id="bookingBoxdate_naissance_fiche_patient" style="position: absolute;z-index: 1;"></div>
                                            </div>
                                            {literal}
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        $( "#date_naissance_fiche_patient" ).datepicker({
                                                            ...
                                                            beforeShow:function(textbox, instance){
                                                                ...
                                                                $('#bookingBoxdate_naissance_fiche_patient').append($('#ui-datepicker-div'));
                                            ...
                                            {/literal}
                                            <div class="col-sm-4 controls">
                                                <input type="text" onkeyup="checkInsee(this);" placeholder="N° de sécurité sociale" name="num_secu_fiche_patient" id="num_secu_fiche_patient" value="" {if $iAccess != '10' or $iAccess=='5'}disabled{/if} />
                                            </div>
                                            <div class="col-sm-4 controls">
                                                <select id="assurance_fiche_patient" name="assurance_fiche_patient" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if}>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 controls">
                                                <input type="text" placeholder="Médecin traitant" name="medecin_traitant_fiche_patient" id="medecin_traitant_fiche_patient" value="" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if} />
                                            </div>
                                            <div class="col-sm-6 controls">
                                                <input type="text" placeholder="Ville du médecin" name="ville_medecin_fiche_patient" id="ville_medecin_fiche_patient" value="" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if} />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12 controls">
                                                <input type="text" placeholder="Profession" name="profession_fiche_patient" id="profession_fiche_patient" value="" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if} />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12 controls">
                                                <textarea placeholder="Remarque patient" name="remarque_fiche_patient" id="remarque_fiche_patient" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if}></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-4 controls">
                                                <div class="input-group">
                                                    <select id="couleur_fiche_patient" {if $iAccess != '10'  && $iAccess!='5'}disabled{/if}>
                                                    ...
                                                    <span id="cadre_couleur_fiche_patient" class="input-group-addon color-input vd_hover" style="color:#008000"><i class="fa fa-square"></i></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-8 controls" style="text-align: right;">
                                                <h4>Fiche créée le : <b><span id='span_fiche_patient_creee_le'></span></b></h4>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-4 controls">
                                                <select id="actif_fiche_patient" name="actif_fiche_patient" required {if $iAccess != '10'}disabled{/if}>
                                                    <option value="">Statut du patient</option>
                                                    <option value="Y">Actif</option>
                                                    <option value="N">Bloqué</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-8 controls" style="text-align: right;">
                                                <h4>Nouveau patient : <b><span id='span_fiche_patient_nouveau'></span></b></h4>
                                            </div>
                                        </div>
                                        <hr>
                                        {if $bloquerInterpro == 'N'}
                                        <div class="form-group">
                                            <div class="col-sm-12 controls" style="text-align: center">
                                                <button type="button" name="btnEnvoiPatientRDVFichePAtient" id="btnEnvoiPatientRDVFichePAtient" class="btn vd_btn vd_bg-color" onclick="initialise_modal_demande_rdv_patient($('#id_fiche_patient').val());"><span class="menu-icon"></span> Initier un RDV pour le patient</button>&nbsp;
                                            </div>
                                        </div>
                                        <hr>
                                        {/if}
                                        <div class="form-group">
                                            <div class="col-sm-12 controls" align="center">
                                                {if $iAccess == '10' or $iAccess=='5'}<button type="submit" name="updateButton" id="updateButton" class="btn vd_btn vd_bg-color"><span class="menu-icon"></span> Modifier</button>&nbsp;&nbsp;{/if}
                                            ...
                                            <div class="panel widget">
                                                <div class="panel-body-list  table-responsive">
                                                    <table class="table table-striped table-hover no-head-border">
                                                        ...
                                                        <tbody id="boucle_historique"></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane col-sm-12" id="profil-tab">
                                ...
                                <div id='div_info_profilage_consentement_patient' style="margin-bottom: 15px;">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="info_profilage_consentement_patient" style="text-align: center;"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="margin-bottom: 15px;">
                                    <div class="row">
                                        <div class="col-md-12" style="text-align: center;">
                                            <button type="button" name="btnGenererPDTFichePAtient" id="btnGenererPDTFichePAtient" class="btn vd_btn vd_bg-color"  onclick="initialise_modal_plan_traitement_patient($('#id_fiche_patient').val());"><span class="menu-icon"><i class='fa fa-plus-circle'></i></span> Ajouter un plan de traitement</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane col-sm-12" id="doc-tab">
                                ...
                                <div class="col-md-12" align="center">
                                    <input style="visibility: collapse; width: 0px;" type="file"  id ="inputFile" onchange="upload_patient_file('{$idc}', '{$ident_user}' )">
                                    {if $iAccess == '10'}<button type="button" name="uploadPatientFile" id="uploadPatientFile" class="btn vd_btn vd_bg-color" onclick="$('#inputFile').click()"><span class="menu-icon"></span>Charger un document</button>&nbsp;&nbsp;{/if}
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="btn vd_btn vd_bg-grey" ><span class="menu-icon"></span> Fermer</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane col-sm-12" id="famille-tab">
                                ...
                                <div id='form_famille_patient' style="display: none;">
                                    <form action="" role="form" id="modal_famille_patient" class="form-horizontal">
                                        <div class="form-group" style="margin-top: 15px">
                                            <div class="col-sm-4 controls">
                                                <div class="vd_input-wrapper-modal" style="background-color:#fff;">
                                                    <input type="hidden" placeholder="" name="id_famille_patient" id="id_famille_patient" value="" {if $iAccess != '10'}disabled{/if} />
                                                    <input type="hidden" placeholder="" name="id_lien_parent" id="id_lien_parent" value="" {if $iAccess != '10'}disabled{/if} />
                                                    <select id="civilite_famille_patient" name="civilite_famille_patient" required class="required" {if $iAccess != '10'}disabled{/if}>
                                                        <option value="">Civilité</option>
                                                        {foreach from=$tabListeCivilite item=tabLC name=stabListeCivilite}
                                                            <option value="{$tabLC.id_civilite}">{$tabLC.abreviation_civilite}</option>
                                                        {/foreach}
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 controls">
                                                <input type="text" placeholder="Nom" name="nom_famille_patient" id="nom_famille_patient" value="" required class="required input-majuscule" {if $iAccess != '10'}disabled{/if} />
                                            </div>
                                            <div class="col-sm-6 controls">
                                                <input type="text" placeholder="Prénom" name="prenom_famille_patient" id="prenom_famille_patient" value="" required class="input-first-letter required"  {if $iAccess != '10'}disabled{/if}/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-6 controls">
                                                <div class="input-group">
                                                    <input type="text" placeholder="Date de naissance" name="date_naissance_famille_patient" id="date_naissance_famille_patient" value="" class="required" required {if $iAccess != '10'}disabled{/if} />
                                                    <span class="input-group-addon" id="datepicker-icon-trigger" data-datepicker="#date_naissance_famille_patient">
                                                      <i class="fa fa-calendar"></i>
                                                    </span>
                                                </div>
                                                <div id="bookingBoxdate_naissance_famille_patient" style="position: absolute;z-index: 1;"></div>
                                            </div>
                                            {literal}
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        $( "#date_naissance_famille_patient" ).datepicker({
                                                            ...
                                                            beforeShow:function(textbox, instance){
                                                                ...
                                                                $('#bookingBoxdate_naissance_famille_patient').append($('#ui-datepicker-div'));
                                                                $('#ui-datepicker-div').hide();
                                                            }
                                                        });
                                                        $( '[data-datepicker]' ).click(function(e){
                                            ...
                                            <div class="col-sm-6 controls">
                                                <div class="vd_input-wrapper-modal" style="background-color:#fff;">
                                                    <select id="parent_famille_patient" name="parent_famille_patient" required class="required" {if $iAccess != '10'}disabled{/if}>
                                                        <option value="">Lien de parenté</option>
                                                        {foreach from=$tabListeParent item=tabLC name=tabListeParent}
                                                            <option value="{$tabLC.identifiant_champ_vrac}">{$tabLC.valeur_champ_vrac}</option>
                                                        {/foreach}
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 controls" align="center">
                                                {if $iAccess == '10'}<button type="button" name="updateButton" id="updateButtonFamille" class="btn vd_btn vd_bg-color" onclick="updateFamilyMember()"><span class="menu-icon"></span> Modifier</button>&nbsp;&nbsp;{/if}
                                                {if $iAccess == '10'}<button type="button" name="updateButton" id="createButtonFamille" class="btn vd_btn vd_bg-color" onclick="createFamilyMember()"><span class="menu-icon"></span> Créer</button>&nbsp;&nbsp;{/if}
                                                <button type="button" onclick="getFamillePatient()" class="btn vd_btn vd_bg-grey"><span class="menu-icon"></span> Fermer</button>
                                ...
                                <div class="col-md-12" align="center" id="family_footer">
                                    {if $iAccess == '10'}<button type="button" name="AddFamilyMember" id="AddFamilyMember" class="btn vd_btn vd_bg-color" onclick="addFamilyMember()"><span class="menu-icon"></span> Ajouter</button>&nbsp;&nbsp;{/if}
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="btn vd_btn vd_bg-grey" ><span class="menu-icon"></span> Fermer</button>
                                </div>
                            </div>
                                                        ...
                                                        $(document).ready(function() {
                                                            $( "#date_naissance_patient_prendre_rdv" ).datepicker({
                                                                ...
                                                                beforeShow:function(textbox, instance){
                                                                    ...
                                                                    $('#bookingBoxdate_naissance_patient_prendre_rdv').append($('#ui-datepicker-div'));
                                                                    $('#ui-datepicker-div').hide();
                                                                }
                                                            });
                                                            $( '[data-datepicker]' ).click(function(e){
...
<!-- [DEBUT] Modal Prendre un rendez-vous Uniquez Nouveau -->
<div style="overflow-x: hidden;overflow-y: auto;z-index:2300;" class="modal fade in" id="modalPrendreRendezVousUnique" tabindex="-1" role="dialog" aria-labelledby="LabelmodalPrendreRendezVousUnique" aria-hidden="false" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                ...
                <div id="wizard-rdv-unique" class="form-wizard">
                    ...
                    <div class="tab-content no-bd" style="padding-top: 0px;">
                        <div class="tab-pane" id="tabPrendreRendezVousUnique1">
                            ...
                            <form class="form-horizontal" action="" role="form" id="form_etape1_prendre_rendez_vous_unique" name="form_etape1_prendre_rendez_vous_unique">
                                <input type="hidden" value="" id="idp_unique" name='idp_unique' />
                                <input type="hidden" value="planning" id="validation_rdv_unique" name='validation_rdv_unique' />
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div id="divcatprofession_prendre_rendez_vous_unique" class="col-sm-12 controls" style='display:none;'>
                                                <div class="label-wrapper">
                                                    <label class="control-label">
                                                        <b>Quel est le professionnel de santé ?</b>
                                                    </label>
                                                ...
                                                <div class="vd_input-wrapper-modal">
                                                    <select name="selectcatprofession_prendre_rendez_vous_unique" id="selectcatprofession_prendre_rendez_vous_unique"></select>
                                                </div>
                                            </div>

                                            <div id="divprofession_prendre_rendez_vous_unique" class="col-sm-12 controls" style='display:none;'>
                                                <div class="label-wrapper">
                                                    <label class="control-label">
                                                        <b>Quelle est la spécialité ?</b>
                                                    </label>
                                                ...
                                                <div class="vd_input-wrapper-modal">
                                                    <select name="selectprofession_prendre_rendez_vous_unique" id="selectprofession_prendre_rendez_vous_unique"></select>
                                                </div>
                                            </div>

                                            <div id="divmotif_prendre_rendez_vous_unique" class="col-sm-12 controls" style="display:none;">
                                                <div class="label-wrapper">
                                                    <label class="control-label">
                                                        <b>Quel est le motif de la consultation ?</b>
                                                    </label>
                                                ...
                                                <div class="vd_input-wrapper-modal">
                                                    <select name="consultation_prendre_rendez_vous_unique" id="consultation_prendre_rendez_vous_unique"></select>
                                                </div>
                                            </div>

                                            <div id="divlieu_prendre_rendez_vous_unique" class="col-sm-12 controls" style="display:none;">
                                                <div class="label-wrapper">
                                                    <label class="control-label">
                                                        <b>Quel est le lieu du rendez-vous ?</b>
                                                    </label>
                                                ...
                                                <div class="vd_input-wrapper-modal">
                                                    <select name="lieu_prendre_rendez_vous_unique" id="lieu_prendre_rendez_vous_unique"></select>
                                                </div>
                                            </div>

                                            <div id="divpraticien_prendre_rendez_vous_unique" class="col-sm-12 controls" style="display:none;">
                                                <div class="label-wrapper">
                                                    <label class="control-label">
                                                        <b>Avec quel praticien ?</b>
                                                    </label>
                                                ...
                                                <div class="vd_input-wrapper-modal">
                                                    <select name="praticien_prendre_rendez_vous_unique" id="praticien_prendre_rendez_vous_unique" ></select>
                                                </div>
                                            </div>
                                ...
                                <div id="divoption_prendre_rendez_vous_unique" class="col-sm-12 controls" style="margin:0px; padding:0px;display:none;">
                                    <div class="form-group">
                                        <div class="col-sm-4 controls" style="margin:0px;">
                                            <div class="label-wrapper">
                                                <label class="control-label">
                                            ...
                                            <div class="input-group">
                                                <input type="text" placeholder="Choisissez une date de début" value="" name="datepicker_rdv_unique" id="datepicker_rdv_unique" class="input-widget-date-left">
                                                <span class="input-group-addon input-widget-date-right" id="datepicker-icon-trigger" data-datepicker="#datepicker_rdv_unique">
                                        <i class="fa fa-calendar"></i>
                                      </span>
                                            </div>
                                            <div id="bookingBoxdatepicker_rdv_unique" style="position: absolute;z-index: 1;"></div>
                                            {literal}
                                                <script type="text/javascript">
                                                    $("#datepicker_rdv_unique").datepicker({
                                                        ...
                                                        beforeShow:function(textbox, instance){
                                                            ...
                                                            $('#bookingBoxdatepicker_rdv_unique').append($('#ui-datepicker-div'));
                                                            $('#ui-datepicker-div').hide();
                                                        }
                                                    });
                                                    $( '[data-datepicker]' ).click(function(e){
                                        ...
                                        <div class="col-sm-4 controls" style="margin:0px;">
                                            ...
                                            <div class="vd_input-wrapper-compte" style="margin:0px;padding:0px;">
                                                <select name="jour_prendre_rendez_vous_unique" id="jour_prendre_rendez_vous_unique">
                                                    <option value="">Indifférent</option>
                                                    <option value="1">Lundi</option>
                                                    <option value="2">Mardi</option>
                                                    <option value="3">Mercredi</option>
                                        ...
                                        <div class="col-sm-4 controls" style="margin:0px;">
                                            ...
                                            <div class="vd_input-wrapper-compte" style="margin:0px;padding:0px;">
                                                <select name="horaire_prendre_rendez_vous_unique" id="horaire_prendre_rendez_vous_unique">
                                                    <option value="">Indifférent</option>
                                                    <option value="6-11">Matin</option>
                                                    <option value="12-21">Après-Midi</option>
                                                    <option value="6-7">06h/08h</option>
                                ...
                                <div class="col-sm-12" align="center">
                                    <button id="btn_recherche_rdv_prendre_rendez_vous_unique" type="button" class="btn vd_btn vd_bg-blue vd_white" onclick="recherche_rdv_prendre_rendez_vous_unique();">Rechercher</button>
                                </div>

                                <div class="col-sm-12" id="return_message_rdv_prendre_rendez_vous_unique" style="display:none;margin-top:10px; margin-bottom:0px;"></div>
                        ...
                        <div class="tab-pane" id="tabPrendreRendezVousUnique2">
                            <div class="col-sm-12 controls" id="divtempcheckpatient_unique" style="display:none;"></div>
                            <hr>
                            <div class="form-group clearfix" id="div_teleconsult_prendre_rdv_unique">
                                <div class="col-sm-6 controls">
                                    ...
                                    <div class="controls" >
                                        <select id="teleconsult_prendre_rdv_unique" name="teleconsult_prendre_rdv_unique">
                                            <option value="Y">Oui</option>
                                            <option value="N" selected>Non</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 controls" id="div_montant_teleconsult_prendre_rdv_unique" style="display: none">
                                    <div class="label-wrapper-modal" >
                                        <label class="control-label">Montant de la téléconsultation :</label>
                                    </div>
                                    <div class="input-group">
                                        <input type="text" id="montant_teleconsult_prendre_rdv_unique" name="montant_teleconsult_prendre_rdv_unique" >
                                        <span class="input-group-addon">€</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 5px;">
                                <div class="col-sm-12 controls" >
                                    <div class="col-sm-8" style="padding-left: 0px;">
                                        <h3><a href="javascript:void(0);" onclick="reduire_div_information_patient_unique();"><i class="fa fa-chevron-circle-down"></i>&nbsp;</a> Informations du patient</h3>
                                    </div>
                                    <div class="col-sm-4" style="padding-right: 0px;" id="div_title_historique_unique">
                            ...
                            <div class="col-sm-12" style="padding-right: 0px;padding-left: 0px;">
                                <form class="form-horizontal" action="#" role="form" id="modal_etape2_prendre_rdv_unique" name="modal_etape2_prendre_rdv_unique" autocomplete="new-password"  >

                                    <div id="div_info_patient_historique_complet_unique">
                                        <div class="col-sm-8" style="padding-left: 0px;">
                                            <input type="hidden" name="id_temp_rdv_unique" value="" id="id_temp_rdv_unique">
                                            <input type="hidden" name="id_praticien_rdv_timestamp_unique" value="" id="id_praticien_rdv_timestamp_unique">
                                            <input type="hidden" name="id_praticien_rdv_unique" value="" id="id_praticien_rdv_unique">
                                            <div class="col-sm-12 controls" id="divenregpatient_unique">
                                                <div class="form-group" {if $rdv_prive_actif!='Y'}style="display:none;"{/if}>
                                                    <div class="col-sm-6 controls">
                                                        ...
                                                        <div class="vd_radio radio-success">
                                                            <input type="radio" name="prive_prendre_rdv_unique" value="Y" id="id_prive_prendre_rdv_unique_oui">
                                                            <label for="id_prive_prendre_rdv_unique_oui">Oui</label>
                                                            <input type="radio" name="prive_prendre_rdv_unique" checked="checked" value="N" id="id_prive_prendre_rdv_unique_non">
                                                            <label for="id_prive_prendre_rdv_unique_non">Non</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="margin-bottom: 5px;">
                                                    <div class="col-sm-12 controls" style="display:none;" id="div_reinit_unique">
                                                        <a href="#" onclick="debloque_modification_patient_modal_prendre_rendez_vous_unique();"><i class="fa fa-pencil"></i> Modifier la fiche patient</a> - <a href='#' onclick="reinitialise_patient_prendre_rendez_vous_unique();" >Réinitialiser</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-3 controls">
                                                        <div class="vd_input-wrapper-compte" style="margin:0px;font-weight:400">
                                                            <select id="civilite_patient_prendre_rdv_unique" name="civilite_patient_prendre_rdv_unique" required class="required" style="border-color: red;">
                                                                <option value="" disabled selected hidden>Civilité</option>
                                                                {foreach from=$tabListeCivilite item=tabLC name=stabListeCivilite}
                                                                    <option value="{$tabLC.id_civilite}">{$tabLC.abreviation_civilite}</option>
                                                                {/foreach}
                                                    ...
                                                    <div class="col-sm-5 controls">
                                                        <input type="text" placeholder="Nom" name="nom_patient_prendre_rdv_unique" id="nom_patient_prendre_rdv_unique" value="" required style="border-color: red;" class="required input-majuscule input-widget" autocomplete="new-password" />
                                                        <input type="hidden" name="id_patient_prendre_rdv_unique" id="id_patient_prendre_rdv_unique">
                                                        {literal}
                                                            <!-- Script pour l'auto-completion -->
                                                            <script type="text/javascript" >
                                                                $("#nom_patient_prendre_rdv_unique").autocomplete({
                                                                    ...
                                                                    select: function (event, ui) {
                                                                        event.preventDefault();
                                                                        getInfoPatientModalPrendreRDV_unique(ui.item.value);
                                                                    },
                                                    ...
                                                    <div class="col-sm-4 controls">
                                                        <input type="text" placeholder="Prénom" name="prenom_patient_prendre_rdv_unique" id="prenom_patient_prendre_rdv_unique" value="" required style="border-color: red;" class="required input-first-letter input-widget" autocomplete="new-password" />
                                                    </div>
                                                </div>
                                                <div class="form-group" id='divnomjeunefille_patient_prendre_rdv_unique' style='display:none;'>
                                                    <div class="col-sm-12 controls">
                                                        <input type="text" placeholder="Nom de naissance" name="nom_jeune_fille_patient_prendre_rdv_unique" id="nom_jeune_fille_patient_prendre_rdv_unique" value="" class="input-majuscule input-widget" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12 controls">
                                                        <input type="text" placeholder="Adresse" name="adresse_patient_prendre_rdv_unique" id="adresse_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-6 controls">
                                                        <input type="text" placeholder="Code postal" name="code_postal_patient_prendre_rdv_unique" id="code_postal_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                    <div class="col-sm-6 controls">
                                                        <input type="text" placeholder="Ville" name="ville_patient_prendre_rdv_unique" id="ville_patient_prendre_rdv_unique" value="" class="input-majuscule input-widget" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="col-sm-6 controls">
                                                        <input type="hidden" name="tel_mobile_patient_prendre_rdv_unique_indicatif" id="tel_mobile_patient_prendre_rdv_unique_indicatif" value="{$num_indicatif_structure}">
                                                        <input type="text" placeholder="Téléphone mobile" name="tel_mobile_patient_prendre_rdv_unique" id="tel_mobile_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                        {literal}
                                                        <script type="text/javascript">
                                                            $(document).ready(function () {
                                                                ...
                                                                if($("#tel_mobile_patient_prendre_rdv_unique_indicatif").val() === "41"){
                                                                    $("#tel_mobile_patient_prendre_rdv_unique").inputmask("999 999 99 99");
                                                                }else if($("#tel_mobile_patient_prendre_rdv_unique_indicatif").val() === "33"){
                                                                    $("#tel_mobile_patient_prendre_rdv_unique").inputmask("99 99 99 99 99");
                                                                }

                                                                $("#tel_mobile_patient_prendre_rdv_unique").on("keyup change", function() {
                                                                    var countryData = $("#tel_mobile_patient_prendre_rdv_unique").intlTelInput("getSelectedCountryData");
                                                                    $("#tel_mobile_patient_prendre_rdv_unique_indicatif").val(countryData.dialCode);
                                                                });

                                                                $("#tel_mobile_patient_prendre_rdv_unique").on("countrychange", function(e, countryData) {
                                                                    $("#tel_mobile_patient_prendre_rdv_unique_indicatif").val(countryData.dialCode);
                                                                    var idpays = countryData.iso2;
                                                                    if(idpays === "fr"){
                                                                        $("#tel_mobile_patient_prendre_rdv_unique").inputmask("99 99 99 99 99");
                                                    ...
                                                    <div class="col-sm-6 controls">
                                                        <input type="hidden" name="tel_fixe_patient_prendre_rdv_unique_indicatif" id="tel_fixe_patient_prendre_rdv_unique_indicatif" value="{$num_indicatif_structure}">
                                                        <input type="text" placeholder="Téléphone fixe" name="tel_fixe_patient_prendre_rdv_unique" id="tel_fixe_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                        {literal}
                                                        <script type="text/javascript">
                                                            $(document).ready(function () {
                                                                ...
                                                                if($("#tel_fixe_patient_prendre_rdv_unique_indicatif").val() === "41"){
                                                                    $("#tel_fixe_patient_prendre_rdv_unique").inputmask("999 999 99 99");
                                                                }else if($("#tel_fixe_patient_prendre_rdv_unique_indicatif").val() === "33"){
                                                                    $("#tel_fixe_patient_prendre_rdv_unique").inputmask("99 99 99 99 99");
                                                                }

                                                                $("#tel_fixe_patient_prendre_rdv_unique").on("keyup change", function() {
                                                                    var countryData = $("#tel_fixe_patient_prendre_rdv_unique").intlTelInput("getSelectedCountryData");
                                                                    $("#tel_fixe_patient_prendre_rdv_unique_indicatif").val(countryData.dialCode);
                                                                });

                                                                $("#tel_fixe_patient_prendre_rdv_unique").on("countrychange", function(e, countryData) {
                                                                    $("#tel_fixe_patient_prendre_rdv_unique_indicatif").val(countryData.dialCode);
                                                                    var idpays = countryData.iso2;
                                                                    if(idpays === "fr"){
                                                                        $("#tel_fixe_patient_prendre_rdv_unique").inputmask("99 99 99 99 99");
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12 controls">
                                                        <input type="email" placeholder="Email" name="email_patient_prendre_rdv_unique" id="email_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-4 controls">
                                                        <div class="input-group">
                                                            <input type="text" placeholder="Date de naissance" name="date_naissance_patient_prendre_rdv_unique" id="date_naissance_patient_prendre_rdv_unique" value="" class="required input-widget-date-left"  required style="border-color: red;">
                                                            <span class="input-group-addon input-widget-date-right" id="datepicker-icon-trigger" data-datepicker="#date_naissance_patient_prendre_rdv_unique">
                                                    <i class="fa fa-calendar"></i>
                                                  </span>
                                                        </div>
                                                        <div id="bookingBoxdate_naissance_patient_prendre_rdv_unique" style="position: absolute;z-index: 1;"></div>
                                                    </div>
                                                    {literal}
                                                        <script type="text/javascript">
                                                            $(document).ready(function() {
                                                                $( "#date_naissance_patient_prendre_rdv_unique" ).datepicker({
                                                                    dateFormat: 'dd/mm/yy',
                                                                    changeMonth: true,
                                                                    changeYear: true,
                                                                    yearRange: "-100:+0",
                                                                    beforeShow:function(textbox, instance){
                                                                        ...
                                                                        $('#bookingBoxdate_naissance_patient_prendre_rdv_unique').append($('#ui-datepicker-div'));
                                                                        $('#ui-datepicker-div').hide();
                                                                    }
                                                                });
                                                                $( '[data-datepicker]' ).click(function(e){
                                                    ...
                                                    {/literal}
                                                    <div class="col-sm-4 controls">
                                                        <input type="text" onkeyup="checkInsee(this);" placeholder="N° de sécurité sociale" name="num_secu_patient_prendre_rdv_unique" id="num_secu_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                    <div class="col-sm-4 controls">
                                                        <div class="vd_input-wrapper-compte" style="margin:0px;font-weight:400">
                                                            <select placeholder="Assurance maladie" id="assurance_patient_prendre_rdv_unique" name="assurance_patient_prendre_rdv_unique">
                                                                <option value="">Veuillez choisir une assurance</option>
                                                                {foreach from=$TabAssurance item=objAssurance}
                                                                    <option value="{$objAssurance.id_assurance_maladie}">{$objAssurance.libelle_assurance_maladie}</option>
                                                                {/foreach}
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-6 controls">
                                                        <input type="text" placeholder="Médecin traitant" name="medecin_traitant_patient_prendre_rdv_unique" id="medecin_traitant_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                    <div class="col-sm-6 controls">
                                                        <input type="text" placeholder="Ville du médecin" name="ville_medecin_patient_prendre_rdv_unique" id="ville_medecin_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-6 controls">
                                                        <div class="input-group">
                                                            ...
                                                            <span id="cadre_couleur_patient_prendre_rdv_unique" class="input-group-addon color-input"><i class="fa fa-square"></i>&nbsp;<i style="color: #000 !important;" class="fa fa-comment"></i></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 controls">
                                                        <input type="text" placeholder="Profession" name="profession_patient_prendre_rdv_unique" id="profession_patient_prendre_rdv_unique" value="" class="input-widget" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12 controls">
                                                        <textarea placeholder="Commentaire" name="remarque_patient_prendre_rdv_unique" id="remarque_patient_prendre_rdv_unique" class="input-widget" ></textarea>
                                                    </div>
                                                </div>
                                                {*<div class="form-group">
                                                    <div class="col-sm-12 controls">
                                                ...
                                                <div class="col-sm-12" align="center" id="div_button_update_patient_unique" style="display:none;">
                                                    <div class="col-sm-12 controls" align="center">
                                                        <button type="button" onclick="modification_patient_modal_prendre_rendez_vous_unique();" name="updateButtonPatient_prendre_rdv_unique" id="updateButtonPatient_prendre_rdv_unique" class="btn vd_btn vd_bg-blue"><span class="menu-icon"></span>Modifier</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4" style="padding-right: 0px;padding-left: 0px;">
                                            <div class="col-sm-12" style='padding-right: 0px;padding-left: 0px;'>
                                                <div id="attente_historique_patient_prendre_rendez_vous_unique" style="display: none;">
                                                    <div align='center' ><br><br><h2>Veuillez patienter...<br><i class='fa fa-spinner fa-spin vd_blue'></i></h2><br><br></div>
                                                </div>
                                                <div id='pas_historique_patient_prendre_rendez_vous_unique' style="display: none;">
                                                    <div class="alert alert-info">
                                                        <span class="vd_alert-icon"><i class="fa fa-info-circle vd_blue"></i></span>
                                                        Aucun historique disponible
                                                    </div>
                                                </div>
                                                <div id='historique_patient_prendre_rendez_vous_unique' style="display: none;">
                                                    <div id="menu_historique_patient_rendez_vous_unique" class="col-sm-12" style="padding-right: 0px;padding-left: 0px;">
                                                        <a href="javascript:void(0);" data-filter=".patienttraite_rendez_vous">
                                                            <div align="center" class="col-sm-3" style="padding-right: 0px;padding-left: 0px;color:#FFFFFF;background-color:lime;height:45px;">
                                                                <b id="libelle_rdv_traite_rendez_vous_unique" title="Patient traité" style="vertical-align: -webkit-baseline-middle;">Tr.</b>
                                                            </div>
                                                        </a>
                                                        <a href="javascript:void(0);" data-filter=".rdvplanifie_rendez_vous">
                                                            <div align="center" class="col-sm-3" style="padding-right: 0px;padding-left: 0px;color:#FFFFFF;background-color:#27a1c2;height:45px;">
                                                                <b id="libelle_rdv_planifie_rendez_vous_unique" title="Rendez-vous planifié" style="vertical-align: -webkit-baseline-middle;">Pl.</b>
                                                            </div>
                                                        </a>
                                                        <a href="javascript:void(0);" data-filter=".absenceexcusee_rendez_vous">
                                                            <div align="center" class="col-sm-3" style="padding-right: 0px;padding-left: 0px;color:#FFFFFF;background-color:orange;height:45px;">
                                                                <b id="libelle_rdv_ab_excusee_rendez_vous_unique" title="Absence Excusée" style="vertical-align: -webkit-baseline-middle;">Abs. Ex.</b>
                                                            </div>
                                                        </a>
                                                        <a href="javascript:void(0);" data-filter=".absencenonexcusee_rendez_vous">
                                                            <div align="center" class="col-sm-3" style="padding-right: 0px;padding-left: 0px;color:#FFFFFF;background-color:red;height:45px;">
                                                                <b id="libelle_rdv_ab_non_excusee_rendez_vous_unique" title="Absence Non Excusée" style="">Abs. Non Ex.</b>
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="col-sm-12" id="boucle_historique_prendre_rendez_vous_unique" style="padding-right: 0px; padding-left: 0px;max-height: 450px;overflow: auto;"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 controls">
                                                ...
                                                <div id="div_repete_toutes_les_unique" class="col-sm-12 controls">
                                                    ...
                                                    <div class="controls" style="margin-left:10px;float: left;">
                                                        <input type="number" name="recurrent_nb_repete_prendre_rdv_unique" id="recurrent_nb_repete_prendre_rdv_unique" min="1" value="1">
                                                    </div>
                                                    <div class="controls" style="margin-left:10px;float: left;">
                                                ...
                                                <div id="div_repete_le_unique" class="col-sm-12 controls">
                                                    ...
                                                    <div>
                                                        <div class="vd_radio radio-success">
                                                            <input id="checkbox-Lundi_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="1">
                                                            <label for="checkbox-Lundi_unique"> Lundi </label>

                                                            <input id="checkbox-Mardi_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="2">
                                                            <label for="checkbox-Mardi_unique"> Mardi </label>

                                                            <input id="checkbox-Mercredi_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="3">
                                                            <label for="checkbox-Mercredi_unique"> Mercredi </label>

                                                            <input id="checkbox-Jeudi_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="4">
                                                            <label for="checkbox-Jeudi_unique"> Jeudi </label>

                                                            <input id="checkbox-Vendredi_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="5">
                                                            <label for="checkbox-Vendredi_unique"> Vendredi </label>

                                                            <input id="checkbox-Samedi_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="6">
                                                            <label for="checkbox-Samedi_unique"> Samedi </label>

                                                            <input id="checkbox-Dimanche_unique" type="radio" name="recurrent_repeter_le_prendre_rdv_unique" value="7">
                                                ...
                                                <div id="div_repete_se_termine_unique" class="col-sm-12 controls">
                                                    ...
                                                    <div>
                                                        {*<div class="vd_radio radio-success">
                                                            <input type="radio" name="recurrent_termine_prendre_rdv_unique"  value="jamais" id="id_recurrent_termine_prendre_rdv_calendar_jamais_unique">
                                                            <label for="id_recurrent_termine_prendre_rdv_calendar_jamais_unique">Jamais</label>
                                                        </div>*}
                                                        <div class="vd_radio radio-success" style="margin-top: 5px;">
                                                            <input type="radio" name="recurrent_termine_prendre_rdv_unique" value="le" id="id_recurrent_termine_prendre_rdv_calendar_le_unique" style="float: left;">
                                                            <label for="id_recurrent_termine_prendre_rdv_calendar_le_unique" style="float: left;">Le</label>
                                                            <div class="col-sm-4 input-group">
                                                                <input type="text" placeholder="" name="reccurent_date_fin_patient_prendre_rdv_unique" id="reccurent_date_fin_patient_prendre_rdv_unique" value="" class="input-widget-date-left">
                                                                <span class="input-group-addon input-widget-date-right" id="datepicker-icon-trigger" data-datepicker="#reccurent_date_fin_patient_prendre_rdv_unique"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                            <div id="bookingBoxreccurent_date_fin_patient_prendre_rdv_unique" style="position: absolute;z-index: 1;"></div>
                                                            {literal}
                                                                <script type="text/javascript">
                                                                    $(document).ready(function() {
                                                                        $( "#reccurent_date_fin_patient_prendre_rdv_unique" ).datepicker({
                                                                            dateFormat: 'dd/mm/yy',
                                                                            changeMonth: true,
                                                                            changeYear: true,
                                                                            beforeShow:function(textbox, instance){
                                                                                ...
                                                                                $('#bookingBoxreccurent_date_fin_patient_prendre_rdv_unique').append($('#ui-datepicker-div'));
                                                                                $('#ui-datepicker-div').hide();
                                                                            }
                                                                        });
                                                                        $( '[data-datepicker]' ).click(function(e){
                                                        ...
                                                        <div class="vd_radio radio-success" style="margin-top: 5px;">
                                                            <input type="radio" name="recurrent_termine_prendre_rdv_unique" checked="checked" value="apres" id="id_recurrent_termine_prendre_rdv_calendar_apres_unique">
                                                            <label for="id_recurrent_termine_prendre_rdv_calendar_apres_unique" style="float: left;">Après</label>
                                                            <div class="controls" style="margin-left:10px;float: left;">
                                                                <input type="number" name="recurrent_occurence_prendre_rdv_unique" id="recurrent_occurence_prendre_rdv_unique" min="2" value="2">
                                                            </div>
                                                ...
                                                <div id="div_btn_generer_rdv_recurrent_unique" class="col-sm-12 controls" style="text-align: center;">
                                                    <button id="btn_generer_rdv_recurrent_unique" name="btn_generer_rdv_recurrent_unique" type="button" class="btn vd_btn btn_widget_standard">Générer les rdv récurrents <span class="menu-icon"><i class="fa fa-fw fa-refresh"></i></span></button>
                                                </div>
                                                <div id="div_liste_rdv_generer_unique" class="col-sm-12 controls" style="margin-bottom: 25px;text-align: center;padding-top: 20px;">
                                                </div>
                                    ...
                                    <div class="col-sm-12" align="center" id="div_button_suivant_unique">
                                        <a id="btn_prec1_unique" class="btn vd_btn prev" href="javascript:void(0);" onclick="retour_tabPrendreRendezVousUnique1();" style="background-color: #8E8E8E;margin: 0px 10px 0px 0px;"><span class="menu-icon"><i class="fa fa-fw fa-chevron-circle-left"></i></span> Retour</a>
                                        <button id="btn_check_patient_prendre_rdv_unique" name="btn_check_patient_prendre_rdv_unique" type="submit" class="btn vd_btn btn_widget_standard">Valider <span class="menu-icon"><i class="fa fa-fw fa-chevron-circle-right"></i></span></button>&nbsp;&nbsp;
                                        <button id="btn_valider_print_unique" name="btn_valider_print_unique" type="submit" class="btn vd_btn btn_widget_standard">Valider et Imprimer <span class="menu-icon"><i class="fa fa-fw fa-print"></i></span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<!-- [FIN] Modal Prendre un rendez-vous Unique Nouveau-->
...
<div style="overflow-x: hidden;overflow-y: auto;z-index:2100;" class="modal fade in" id="modalFicheRendezVous" tabindex="-1" role="dialog" aria-labelledby="LabelmodalPrendreRendezVous" aria-hidden="false">
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="LabelmodalPrendreRendezVous">Fiche rendez-vous</h4>
            </div>
            <div class="modal-body">
                ...
                <div id="div_info_fiche_rendez_vous" >
                    <div class="col-sm-12" style="padding-top:10px;">
                        ...
                        <form action="#" class="form-horizontal" role="form" id="form_fiche_rendez_vous" name="form_fiche_rendez_vous" >
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 controls">
                                    <h3 id="nom_docteur_fiche_rendez_vous" ></h3>
                                    <h3 id="nom_lieux_fiche_rendez_vous" ></h3>
                                </div>
                                <div class="col-sm-6 controls">
                                    <h3 id="provenance_fiche_rendez_vous" ></h3>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6 controls">
                                    ...
                                    <div class="controls">
                                        <select id="status_fiche_rendez_vous" name="status_fiche_rendez_vous" {if $iAccess != '10'}disabled{/if}></select>
                                    </div>
                                </div>
                                <div class="col-sm-6 controls">
                                    <label class="control-label">Motif</label>
                                    <div class="controls">
                                        <select id="motif_fiche_rendez_vous" name="motif_fiche_rendez_vous" onchange="select_motif_temps(this.value)"  {if $iAccess != '10'}disabled{/if}></select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group bootstrap-timepicker">
                                        ...
                                        {literal}
                                            <script type="text/javascript">
                                                $(document).ready(function () {
                                                    $("#timerdvaff_fiche_rendez_vous").clockpicker({
                                                        placement: 'bottom',
                                                        autoclose: true
                                                    });
                                                    $("#timerdvaff_fiche_rendez_vous").mask("99:99");
                                                });
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group bootstrap-timepicker">
                                        ...
                                        {literal}
                                            <script type="text/javascript">
                                                $(document).ready(function () {
                                                    $("#timerdvreel_fiche_rendez_vous").clockpicker({
                                                        placement: 'bottom',
                                                        autoclose: true
                                                    });
                                                    $("#timerdvreel_fiche_rendez_vous").mask("99:99");
                                                });
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 controls">
                                    ...
                                    {if $iAccess == '10'}
                                    &nbsp;&nbsp;<a href="#" onclick="$('#provenance_open').val('modal_fiche_rendez_vous');$('#modalFichePatient').modal('show');getInfoPatient($('#id_patient_fiche_rendez_vous').val());"><i class="fa fa-pencil"></i> Modifier la fiche patient</a>
                                    {/if}
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            {/if}
                            {*<div class="form-group" id="div_teleconsult_rendez_vous" style="display: none">
                                <div class="col-sm-6 controls">
                                    <label class="control-label">RDV en téléconsultation</label>
                                    <div class="controls">
                                        <select id="teleconsult_fiche_rendez_vous" name="teleconsult_fiche_rendez_vous">
                                            <option value="Y">Oui</option>
                                            <option value="N" selected>Non</option>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group"  id="div_bouton_rendez_vous">
                                ...
                                <div class="col-sm-4 controls" align="center"></div>
                                   ...
                                   {* <div  class="btn-group col-sm-4 controls" align="center">
                                        <button type="button"  class="btn btn-default dropdown-toggle vd_bg-blue" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="menu-icon"></span>Menu osteo <span class="caret"></span>
                                         </button>
                                        <ul class="dropdown-menu">
                                            <li><a href="main.php?dir=recaposteo&id_entite={{$id_entite}}" target="_blank">Modifier</a></li>
                                        </ul>
                                    </div>
                                    *}
                                    {if $iAccess == '10'}
...
<div style="overflow-x: hidden;overflow-y: auto;" class="modal fade in" id="modalPlanTraitementPatient" tabindex="-1" role="dialog" aria-labelledby="LabelmodalPlanTraitementPatient" aria-hidden="false" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header vd_bg-blue vd_white">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
