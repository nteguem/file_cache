...
{/if}
{if isset($aListe)}
<div class="clearfix no-print vd_bg-white" style="margin:0; padding:10px">
    <div class="vd_panel-header" style="display:flex; justify-content:space-between; align-items:center;">
        <h1>{$sTitreListe}</h1>
        ...
        {if $sLabelCreationElem!=''}
            <a href="{$sLabelCreationElemUrl}&pagesimple={$pagesimple}" alt="{$sLabelCreationElem}">
                <button type="button" class="btn bg_dark_blue vd_white">{$sLabelCreationElem}</button>
                  {if $bActivtraduction=='Yes'}
...
<div>
    ...
    {if isset($aRech) and $aRech|@count > 0}
        <div class="row no-print" id="form-basic" style="margin-bottom:0px;">
            <div>
                <div style="overflow: auto;">
                    <div class="panel-heading bg_light_blue dark_blue" data-toggle="collapse" href="#formrech" role="button" aria-expanded="true" aria-controls="formrech" style="margin-bottom:5px;">
                        <h4 style="margin:0 10px"> <span class="menu-icon"> <i class="fa fa-search"></i> </span>{$sLabelRecherche} <i class="fa fa-caret-up collapseCaret" aria-hidden="true"></i></h4>
                        
                    </div> 
                    <div class="panel-body collapse in" id="formrech">
                        <form action="" role="form" id="formList" method="GET" {if isset($bTelechargementFichier) and $bTelechargementFichier}enctype="multipart/form-data"{/if}>
                            ...
                            {foreach from=$aRech item=objRech}
                                {if isset($objRech.type_champ) and ((isset($objRech.aff_recherche) and $objRech.aff_recherche eq 'ok') or ($objRech.type_champ eq 'category' or $objRech.type_champ eq 'bouton'))}
                                    {if $objRech.type_champ eq 'text'}
                                        ...
                                        style='{if isset($objRech.fonction_javascript) and is_array($objRech.fonction_javascript) and array_key_exists('order',$objRech.fonction_javascript)}order:{$objRech.fonction_javascript['order']}{/if}'
                                        >
                                            ...
                                            <div class="controls">
                                                <input 
                                                    ...
                                                    style="{if isset($objRech.style) and $objRech.style neq ''}{$objRech.style}{/if}"
                                            ...
                                            <div class="controls">
                                                {if isset($objRech.select2) and $objRech.select2 eq 'ok'}
                                                    ...
                                                    <div class="input-group" style="width:100%" id="id_selectmotif">
                                                        ...
                                                        class="{if isset($objRech.ctrl_champ) and $objRech.ctrl_champ eq 'ok'} required {/if} js-example-basic-multiple customSelect2" 
                                                        name="{$objRech.nom_variable}{if isset($objRech.multiple)}[]{/if}"
                                                        {if isset($objRech.multiple)}multiple{/if}
                                                        style="width:100%;{if isset($objRech.style) and $objRech.style neq ''}{$objRech.style}{/if}"
                                                        >
                                                            <option value="" {if empty($objRech.valeur_variable)}selected="selected"{/if} >Tous</option>
                                                            {if is_array($objRech.lesitem)}
                                                                {foreach from=$objRech.lesitem key=id_valeur_possible item=valeur_possible_bdd}
                                                                    <option value="{$id_valeur_possible}" {if $objRech.valeur_variable !== "" && ($objRech.valeur_variable eq $id_valeur_possible || (isset($objRech.multiple) && in_array("{$id_valeur_possible}",$objRech.valeur_variable)))}selected="selected"{/if} >
                                                                        {$valeur_possible_bdd}
                                                                    </option>
                                                                {/foreach}
                                                            {/if}
                                ...
                                {/literal}
                                    ...
                                    {elseif $objRech.type_champ eq 'number'}
                                        <div class="form-group" style="{if isset($objRech.style) and $objRech.style neq ''}{$objRech.style}{/if}
                                        {if isset($objRech.fonction_javascript) and is_array($objRech.fonction_javascript) and array_key_exists('order',$objRech.fonction_javascript)};order:{$objRech.fonction_javascript['order']}{/if}
                                            ">
                                            <label class="control-label" for="id_{$objRech.nom_variable}">{$objRech.text_label}</label>
                                            <div class="controls">
                                                <input type="number" min="0" step="1"
                                                        {if isset($objRech.nom_variable)}name="{$objRech.nom_variable}"  id="id_{$objRech.nom_variable}"{/if}
                                                        {if isset($objRech.valeur_variable)}value="{$objRech.valeur_variable}"{/if}
                                                        {if isset($objRech.placeholder) && !empty($objRech.placeholder)}placeholder="{$objRech.placeholder}"{/if}
                                                >
                                            </div>
                                        </div>
                                    {elseif $objRech.type_champ eq 'date'}
                                            ...
                                            {literal}
                                                ...
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        const controlPeriod = {/literal}{if isset($objRech.controlPeriod) && $objRech.controlPeriod === 'ok'}true{else}false{/if}{literal};
                                                        const startInput = $( "{/literal}#id_{$objRech.nom_variable}_1{literal}" )
                                                        const endInput = $( "{/literal}#id_{$objRech.nom_variable}_2{literal}" )
                                                        startInput.datepicker({
                                                            dateFormat: 'dd/mm/yy',
                                                            changeMonth: true,
                                                            changeYear: true,
                                                            maxDate: controlPeriod?endInput.val():undefined
                                                        });
                                                        ...
                                                        endInput.datepicker({
                                                            ...
                                                            changeMonth: true,
                                                            changeYear: true,
                                                            minDate: controlPeriod?startInput.val():undefined
                                                        });
                                                        ...
                                                        if(controlPeriod){
                                                            startInput.on('change', (e) => {
                                                                ...
                                                                endInput.datepicker( "option", "minDate", new Date(parsedDate) );
                                                            })

                                                            endInput.on('change', (e) => {
                                                                const parsedDate = moment(e.target.value,'DD/MM/YYYY').toDate()
                                                                const parsedDateObject = new Date(parsedDate);
                                                                startInput.datepicker( "option", "maxDate", parsedDateObject );
                                                                if(startInput.val() === ''){
                                                                    startInput.val(moment().format('DD/MM/YYYY'));
                                                                }
                                                            })
                                                        }
                                        ...
                                        style='{if isset($objRech.fonction_javascript) and is_array($objRech.fonction_javascript) and array_key_exists('order',$objRech.fonction_javascript)}order:{$objRech.fonction_javascript['order']}{/if}'
                                            >
                                                ...
                                                <div class="controls">
                                                    <div class="input-group">
                                                    {$objRech.valeur_variable}

                                                        <input 
                                                            type="text"
                                                            class="{if isset($objRech.ctrl_champ) and $objRech.ctrl_champ eq 'ok' and $bActiveFormSelect} required {/if}" 
                                                            {if isset($objRech.placeholder) && !empty($objRech.placeholder)}placeholder={$objRech.placeholder}{/if}
                                                            ...
                                                            {if isset($objRech.fonction_javascript) and $objRech.fonction_javascript|is_array}
                                                                ...
                                                                {/foreach}
                                                            {/if}
                                                            {if isset($objRech.ctrl_champ) and $objRech.ctrl_champ eq 'ok' and $bActiveFormSelect} required {/if}
                                                        >
                            ...
                            <div class="form-actions">
                                <div class="validationButtons" style='text-align:center;'>
                                    
                                    {if isset($itemBoutons.reset)}
                                        <a class="validationButton btn vd_btn roundButton borderBlueButton largeTextButton" 
                                            href="{$itemBoutons.reset.url}"
                                    ...
                                    {if isset($itemBoutons.valider)}
                                        <button
                                            type="submit"
                                            class="btn vd_btn roundButton vd_bg-green validationButton largeTextButton"
        ...
        {if ! isset($noSearchCount) || !$noSearchCount}
    ...
    {if $bAffListe}
        ...
        <div class="">
            <div class="panel widget" >
                <div class="panel-heading bg_light_blue dark_blue">
                ...
                <div class="panel-body-list table-responsive" style="overflow: auto;">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                {foreach from=$aEnteteListe item=objEnteteListe}
                                    {if $objEnteteListe.objElement.type_champ!='hidden' and $objEnteteListe.objElement.type_champ!='chplussansafficheliste'}
                                    <th {if isset($objEnteteListe.objElement.style_liste)}style='{$objEnteteListe.objElement.style_liste}'{/if}>{$objEnteteListe.sLabel}
                                    {if $bActivtraduction=='Yes'}
                        ...
                        <tbody>
                        {foreach from=$aListe item=objListe key=objKey}
                            <tr>
                                {if $bActiveFormSelect or $bRadioSelect or $bCheckboxSelect}
                                ...
                                {foreach name="enteteliste" from=$aEnteteListe item=objEnteteListe}
                                    {if $objEnteteListe.objElement.type_champ!='hidden' and $objEnteteListe.objElement.type_champ!='chplussansafficheliste'}
                                        <td class="center" {if isset($objEnteteListe.objElement.style_liste)}style='{$objEnteteListe.objElement.style_liste}'{/if}>
                                            ...
                                            {else}
                                                ...
                                                {elseif $objEnteteListe.objElement.type_champ=='chplussansafficheliste'}
                                                {else}
                                ...
                                {if $bAffFiche or $bAffMod or $bAffSupp}
                                    <td class="menu-action rounded-btn" id="icones_action" style="vertical-align: middle;">
                                        {if $bAffFiche}
                                            <button onclick='showModalHandle({$objKey})' class="btn menu-icon vd_bd-blue vd_blue">
...
{if isset($bAffFiche) and $bAffFiche}
    {include file="modal_recap_consign.tpl"}
    <script>
        function showModalHandle(id){
            const elements = {$aListe|@json_encode nofilter}
            showModalRecap(elements[id]);
        }
    </script>
