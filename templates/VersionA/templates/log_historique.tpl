    ...
    <div class="panel widget">
        ...
        <div class="panel-body" id="formRechConflitAbsence">
            <form class="form-horizontal" action="" role="form" id="formList" method="GET">
                ...
                <input type="hidden" name="dir" value="loghistouser">

                {* 1er ligne du formulaire *}
                <div class="form-group" id="recherche_1">

                    <div class="col-sm-3">
                        <label class="control-label font-size">Id ressoure :</label>
                        <div class="controls">
                            <input class="input" type="text" name="ressource" id="ressource" value="">
                        </div>
                    </div>

                    <div class="col-sm-3">
                        <label class="control-label font-size">Ressource :</label>
                        <div class="controls">
                            <select name="typeressource">
                                <option></option>
                                {foreach from=$aTabRessource item=ressource}
                    ...
                    <div class="col-sm-3">
                        <label class="control-label font-size">Action :</label>
                        <div class="controls" id="id_entite">
                        <select id="id_action"  name="action">
                            <option></option>
                            {foreach from=$aTabAction item=action}
...
<div class="col-sm-12">
    ...
    <table id="liste_Oplus" border="1">
        ...
        <tbody>
        {foreach from=$aTablog item=rdv name=rdv_log}
            <tr class="">
                <td class="date">{$rdv.date}</td>
                <td class="action">{$rdv.methode}</td>
                <td class="Ressource">{$rdv.objet}</td>
                <td class="Id ressource">{$rdv.ressource}</td>
                <td class="Script">{$rdv.script}</td>
