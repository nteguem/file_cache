...
<head>
    ...
    <?php $bootstrapMin = filemtime(PATH_ASSETS.'js/bootstrap.min'); ?>
    <script type="text/javascript" src="js/bootstrap.min.<?php echo $bootstrapMin ?>.js"></script>

    <?php $jQuerryUICustomMin = filemtime(PATH_ASSETS.'plugins/jquery-ui/jquery-ui.custom.min'); ?>
    <script type="text/javascript" src='plugins/jquery-ui/jquery-ui.custom.min.<?php echo $jQuerryUICustomMin ?>.js'></script>

    <?php $jQuerryUITouchPunchMin = filemtime(PATH_ASSETS.'plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min'); ?>
    ...
    <?php $caroufredsel = filemtime(PATH_ASSETS.'js/caroufredsel'); ?>
    <script type="text/javascript" src="js/caroufredsel.<?php echo $caroufredsel ?>.js"></script>

    <?php $plugins = filemtime(PATH_ASSETS.'js/plugins'); ?>
    <script type="text/javascript" src="js/plugins.<?php echo $plugins ?>.js"></script>

    <?php $breakpoints = filemtime(PATH_ASSETS.'plugins/breakpoints/breakpoints'); ?>
    <script type="text/javascript" src="plugins/breakpoints/breakpoints.<?php echo $breakpoints ?>.js"></script>

    <?php $jQuerryDataTablesMin = filemtime(PATH_ASSETS.'plugins/dataTables/jquery.dataTables.min'); ?>
    ...
    <?php $jQuerryTagsInputMin = filemtime(PATH_ASSETS.'plugins/tagsInput/jquery.tagsinput.min'); ?>
    <script type="text/javascript" src="plugins/tagsInput/jquery.tagsinput.min.<?php echo $jQuerryTagsInputMin ?>.js"></script>

    <?php $bootstratSwithMin = filemtime(PATH_ASSETS.'plugins/bootstrap-switch/bootstrap-switch.min'); ?>
    <script type="text/javascript" src="plugins/bootstrap-switch/bootstrap-switch.min.<?php echo $bootstratSwithMin ?>.js"></script>
    ...
    <?php $jQuerryPnotify = filemtime(PATH_ASSETS.'plugins/pnotify/js/jquery.pnotify.min'); ?>
    <script type="text/javascript" src="plugins/pnotify/js/jquery.pnotify.min.<?php echo $jQuerryPnotify ?>.js"></script>

    <?php $jQuerrymCustomScrollBarConcatMin2 = filemtime(PATH_ASSETS.'js/jquery.mCustomScrollbar.concat.min'); ?>
    <script type="text/javascript" src="js/jquery.mCustomScrollbar.concat.min.<?php echo $jQuerrymCustomScrollBarConcatMin2 ?>.js"></script>


    <?php $jQuerryMouseWheelMin = filemtime(PATH_ASSETS.'js/jquery.mousewheel.min'); ?>
    <script type="text/javascript" src="js/jquery.mousewheel.min.<?php echo $jQuerryMouseWheelMin ?>.js"></script>


    <?php $theme = filemtime(PATH_ASSETS.'js/theme'); ?>
    <script type="text/javascript" src="js/theme.<?php echo $theme ?>.js?1454423157"></script>

    <?php $custom = filemtime(PATH_ASSETS.'custom/custom'); ?>
    <script type="text/javascript" src="custom/custom.<?php echo $custom ?>.js?1454423157"></script>

    <!-- Specific Page Scripts Put Here -->

    <?php $jQuerryBootstrapWizardMin = filemtime(PATH_ASSETS.'plugins/bootstrap-wizard/jquery.bootstrap.wizard.min'); ?>
    ...
    <!-- Head SCRIPTS -->
    <?php $modernizr = filemtime(PATH_ASSETS.'js/modernizr'); ?>
    ...
    <?php $jQuerryMaskedInputMin = filemtime(PATH_ASSETS.'js/jquery.maskedinput.min'); ?>
