...
{/if}
    {if isset($bfom1)}
        ...
        <form action="main.php?pagesimple={$pagesimple}" method="GET">
            ...
            <div class="form-group">
                 <div class="col-sm-6 controls">
                    <input type="text" placeholder="id lieu" name="lieu" value="{$lieu}">
                </div>

            </div>
            <div class="form-group">
                <div class="col-sm-6 controls">
                    <input type="text" name="motif" placeholder="id type rdv" id="idaff_nom"  value="{$motif}" >&nbsp;&nbsp;&nbsp;
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-6 controls">
                    <input type="text" name="praticien" placeholder="liste praticien sépare par une virgule" id="idaff_nom"  value="{$praticien}" >&nbsp;&nbsp;&nbsp;
                </div>
            </div>

            <div class="form-group">
                <div class="col-sm-6 controls">
                    <input type="text" name="autre" placeholder="autre cles key=valeur;" id="idaff_nom"  value="{$autre}" >&nbsp;&nbsp;&nbsp;
                </div>
            </div>
