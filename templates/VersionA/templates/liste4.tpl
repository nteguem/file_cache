...
?>
        ...
        <div class="no-print" style="margin-bottom:20px;"><b></b></div>
    {/if}
    ...
    {if $bAffListe}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel widget">
                    <div class="panel-heading vd_bg-grey">
                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>{$sTitreListe} {$iTabListeCount} {$sLabelNbrLigne}
