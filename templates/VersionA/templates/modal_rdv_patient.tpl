...
<head>
    ...
    <script type="text/javascript" src="js/jquery.{jqPatient}.js"></script> 
    <!--[if lt IE 9]>
      <script type="text/javascript" src="js/excanvas.js"></script>      
    <![endif]-->
    <script type="text/javascript" src="js/bootstrap.min.{minPatient}.js"></script> 
    <script type="text/javascript" src='plugins/jquery-ui/jquery-ui.custom.min.{cMinPatient}.js'></script>
    <script type="text/javascript" src="plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.{punchPatient}.js"></script>

    <script type="text/javascript" src="js/caroufredsel.{crPatient}.js"></script> 
    <script type="text/javascript" src="js/plugins.{plgPatient}.js"></script>

    <script type="text/javascript" src="plugins/breakpoints/breakpoints.{breackPatient}.js"></script>
    <script type="text/javascript" src="plugins/dataTables/jquery.dataTables.min.{jqDtPatient}.js"></script>
    <script type="text/javascript" src="plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.{prtPatient}.js"></script> 

    <script type="text/javascript" src="plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.{mCPatient}.js"></script>
    <script type="text/javascript" src="plugins/tagsInput/jquery.tagsinput.min.{mnPatient}.js"></script>
    <script type="text/javascript" src="plugins/bootstrap-switch/bootstrap-switch.min.{smPatient}.js"></script>
    <script type="text/javascript" src="plugins/blockUI/jquery.blockUI.{blPatient}.js"></script>
    <script type="text/javascript" src="plugins/pnotify/js/jquery.pnotify.min.{pnPatient}.js"></script>

    <script type="text/javascript" src="js/theme.{thPatient}.js"></script>
    <script type="text/javascript" src="custom/custom.{ccPatient}.js"></script>
     
    <!-- Specific Page Scripts Put Here -->

    <script type="text/javascript" src='plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.{wiz_rdv_patient}.js'></script>

    <script type="text/javascript" src="js/datepicker-fr.{dpPatient}.js"></script>
    <!-- Head SCRIPTS -->
    <script type="text/javascript" src="js/modernizr.{zrPatient}.js"></script> 
    <script type="text/javascript" src="js/mobile-detect.min.{minPatient}.js"></script> 
    <script type="text/javascript" src="js/mobile-detect-modernizr.{mzrPatient}.js"></script> 
    <script type="text/javascript" src="js/jquery.maskedinput.min.{mskPatient}.js"></script> 
    
    <script type="text/javascript" src="js/compte_widget.{wdPatient}.js"></script>
   <!-- Script pour l'auto-completion -->
    <script type="text/javascript" src="js/jquery.autocomplete.min.{autoPatient}.js"></script>
