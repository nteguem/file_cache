...
@media(max-width:1300px){
  ...
  {/literal}$window.scrollTop()<=300{literal}
    #ulcalendar{
...
<script type="text/javascript">
    $(document).ready(function () {
       ...
       $('#basculer_agenda').on('change', function () {
            window.location.replace('main.php?dir=agendabox&typeuser=BOX&identifiant_user=' + $('#basculer_agenda').val()+'&typeuser=BOX');
            //window.location.replace('main.php?dir=agendabox&identifiant_user=' + $('#basculer_agenda').val());
        });
...
<input type="hidden" name="id_rdv_copypaste" id="id_rdv_copypaste" value="{$id_rdv_copypaste}">
    ...
    <div class="col-sm-3" id="autre_box">
            ...
            <select name="lstAgendaActif" class="js-example-basic-multiple" id="basculer_agenda">
                ...
                <option></option>
                    <option value="{$objAgenda['identifiant_user']}"
                            {if {$objAgenda['identifiant_user']}==$identifiant_user}selected{/if}>{if isset($objAgenda['nom_affichage_calendar_user']) and $objAgenda['nom_affichage_calendar_user'] !=''}{$objAgenda['nom_affichage_calendar_user']}{else} {$objAgenda['nom_user']}{/if}</option>
                    </option>
                {/foreach}
            </select>
            {literal}
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="panel widget light-widget">
        <div class="panel-body" style="padding:1px 15px!important;">

          <div class="btn_param no-print" style="height: 53px; padding-top:1px!important">
            <div id="div_param_agenda" class="vd_content-section clearfix row" style="display:none;">
              <form class="form-horizontal" action="main.php?dir=agendabox" role="form" id="form_filtre_agenda" method="POST">
                ...
                <li {if $smarty.foreach.sTabPraticien.iteration==1}class="active"{/if} >
                  ...
                  <div title="Configuration" data-placement="bottom" class="width-sm-1" style="position:absolute;z-index:{50-$smarty.foreach.sTabPraticien.iteration};margin-left:10px;margin-top:10px;cursor:pointer;">
                      ...
                      {if !empty($aTableauMenu[2][4]) }
                            ...
                            <li><a href="main.php?dir=boc_box_user&action=form&id_user={$tabP.id_user}"   {if $bActivtraduction=='Y'}style="display:inline;padding: 4px 4px;"{/if}>Fiche BOX</a>
                            ...
                            <li><a href="main.php?dir={$dirPlanning}&identifiant_user={$tabP.identifiant_user}&typeuser=box" {if $bActivtraduction=='Y'}style="display:inline;padding: 4px 4px;"{/if}>{$MenuCalendarDispographique}</a>
                              {if $bActivtraduction=='Y'}
                  ...
                  <a href="#tab{$tabP.id_user}" sidtab="{$tabP.id_user}" data-toggle="tab" style="background-color: {$tabP.couleur_user}">
                    ...
                    <h4><b>{if $tabP.nom_affichage_calendar_user!=''}{$tabP.nom_affichage_calendar_user}{else}{$tabP.nom_user}{/if}&nbsp;</b>
        ...
        <div id="div_info_enregistrer_rendez_vous" >
          ...
          <div id="divMessageRemplacant"  class="alert alert-warning" style="display: none;">
            ...
            <form class="form-horizontal" action="#" role="form" id="modal_enregistrer_rdv" name="modal_enregistrer_rdv" autocomplete="new-password" >
              ...
              <div class="form-group">
                <div class="col-sm-6 controls">
                  <select id="id_praticien_prendre_rdv_calendar" name="id_praticien_prendre_rdv_calendar" required {if $bblocageall} disabled{/if} class="js-example-basic-single" style="width:100%!important";>
                ...
                <div class="col-sm-6 controls">
                  <select id="type_rdv_calendar" name="type_rdv_calendar" required onchange="select_tmp(this.value)" {if $bblocageall} disabled{/if} class="js-example-basic-single" style="width:100%!important";>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-6 controls">
                  <select id='id_lieu_prendre_rdv_calendar' name="id_lieu_prendre_rdv_calendar" required {if $bblocageall} disabled{/if} class="js-example-basic-single" style="width:100%!important";>
                        ...
                        <div class="form-group">
                          <div class="col-sm-3 controls">
                            <div class="vd_input-wrapper-compte" style="margin:0px;font-weight:400">
                              <select id="civilite_patient_prendre_rdv_calendar" name="civilite_patient_prendre_rdv_calendar" required class="required" style="border-color: red;border-radius: 5px">
                        ...
                        <div class="form-group">
                          <div class="col-sm-12 controls">
                            ...
                            <div class="controls" style="margin-left:10px;float: left;">
                              <select id="recurrent_prendre_rdv_calendar" class="js-example-basic-single" style="width:100%!important";>
                                  <option value="N" selected>Non</option>
                                  <option value="Y">Oui</option>
                              </select>
                            </div>
