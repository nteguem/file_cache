...
<head>
    ...
    <link href="css/bootstrap.min.{$booTModalPatTraite}.css" rel="stylesheet" type="text/css">
    <link href="css/font-awesome.min.{$aWModalPatTraite}.css" rel="stylesheet" type="text/css">

    <!--[if IE 7]><link type="text/css" rel="stylesheet" href="css/font-awesome-ie7.min.css"><![endif]-->
    <link href="css/font-entypo.{$entModalPatTraite}.css" rel="stylesheet" type="text/css">

    <!-- Fonts CSS -->
    <link href="css/fonts.{$ftModalPatTraite}.css"  rel="stylesheet" type="text/css">
               
    <!-- Plugin CSS -->
    <link href="plugins/jquery-ui/jquery-ui.custom.min.{$cmModalPatTraite}.css" rel="stylesheet" type="text/css">    
    <link href="plugins/prettyPhoto-plugin/css/prettyPhoto.{$preModalPatTraite}.css" rel="stylesheet" type="text/css">
    <link href="plugins/isotope/css/isotope.{$icIModalPatTraite}.css" rel="stylesheet" type="text/css">
    <link href="plugins/pnotify/css/jquery.pnotify.{$pnModalPatTraite}.css" media="screen" rel="stylesheet" type="text/css">    
    <link href="plugins/google-code-prettify/prettify.{$pretModalPatTraite}.css" rel="stylesheet" type="text/css"> 

    <link href="plugins/mCustomScrollbar/jquery.mCustomScrollbar.{$mCModalPatTraite}.css" rel="stylesheet" type="text/css">
    <link href="plugins/tagsInput/jquery.tagsinput.{$tagsModalPatTraite}.css" rel="stylesheet" type="text/css">
    <link href="plugins/bootstrap-switch/bootstrap-switch.{$sWModalPatTraite}.css" rel="stylesheet" type="text/css">    
    <link href="plugins/daterangepicker/daterangepicker-bs3.{$bs3ModalPatTraite}.css" rel="stylesheet" type="text/css">    
    <link href="plugins/bootstrap-timepicker/bootstrap-timepicker.min.{$tmModalPatTraite}.css" rel="stylesheet" type="text/css">
    <link href="plugins/colorpicker/css/colorpicker.{$clorModalPatTraite}.css" rel="stylesheet" type="text/css">            

    <!-- Theme CSS -->
    <link href="css/theme.min.{$thModalPatTraite}.css" rel="stylesheet" type="text/css">
    <!--[if IE]> <link href="css/ie.css" rel="stylesheet" > <![endif]-->
    <link href="css/chrome.{$chrModalPatTraite}.css" rel="stylesheet" type="text/chrome">
    <!-- chrome only css -->    


        
    <!-- Responsive CSS -->
    <link href="css/theme-responsive.min.{$respModalPatTraite}.css" rel="stylesheet" type="text/css">
    ...
    <!-- Custom CSS -->
    <link href="custom/custom.{$ccModalPatTraite}.css" rel="stylesheet" type="text/css">
