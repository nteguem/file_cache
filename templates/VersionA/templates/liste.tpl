                            ...
                            {foreach from=$aRech item=objRech}
                                            ...
                                            <div class="col-sm-6 controls">
                                                {if isset($objRech.select2) and $objRech.select2 eq 'ok'}
                                                    ...
                                                    <div class="col-sm-12 input-group" id="id_selectmotif">
                                                        ...
                                                        {if isset($objRech.size_champ)}
                                                            style="width: {$objRech.size_champ}"
                                                        {/if}
                                                        ...
                                                        >
                                                            ...
                                                            {if is_array($objRech.lesitem)}
                                                                {foreach from=$objRech.lesitem key=id_valeur_possible item=valeur_possible_bdd}
                                                                    <option value="{$id_valeur_possible}"   {if $objRech.valeur_variable eq $id_valeur_possible || (isset($objRech.multiple) && in_array("{$id_valeur_possible}",$objRech.valeur_variable))}selected="selected"{/if} >
                                                                        {$valeur_possible_bdd}
                                                                    </option>
                                                                {/foreach}
                                                            {/if}
                                ...
                                {/literal}
                                    ...
                                    {elseif $objRech.type_champ eq 'number'}
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="id_{$objRech.nom_variable}">{$objRech.text_label}</label>
                                            <div class="col-sm-6 controls">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {/if}
                                                    <div class="input-group">
                                                        ...
                                                        {/if}
                                                        {if isset($objRech.fonction_javascript) and $objRech.fonction_javascript|is_array}
                                                            {if isset($objRech.fonction_javascript[0])}
                                                                {foreach from=$objRech.fonction_javascript[0] key=cle item=valeur}
                                                                    {$cle}="{$valeur}"
                                                                {/foreach}
                                                            {else}
                                                                {foreach from=$objRech.fonction_javascript key=cle item=valeur}
                                                ...
                                                {/if}
                                                    <div class="input-group">
                                                        ...
                                                        {/if}
                                                        {if isset($objRech.fonction_javascript) and $objRech.fonction_javascript|is_array}
                                                            {if isset($objRech.fonction_javascript[1])}
                                                                {foreach from=$objRech.fonction_javascript[1] key=cle item=valeur}
                                                                    {$cle}="{$valeur}"
                                                                {/foreach}
                                                            {else}
                                                                {foreach from=$objRech.fonction_javascript key=cle item=valeur}
