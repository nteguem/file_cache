...
<div class="vd_content-section clearfix">
        ...
        <div class="row" id="form-basic" style="margin-bottom:0px;">
            <div class="col-md-12">
                <div class="panel widget" style="margin-bottom:0px;">
                    ...
                    <div class="panel-body" style="padding-bottom:0px;display: none"  id="formrech">
                                ...
                                {if isset($objRech.type_champ) and ((isset($objRech.aff_recherche) and $objRech.aff_recherche eq 'ok') or ($objRech.type_champ eq 'category' or $objRech.type_champ eq 'bouton'))}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">{$objRech.text_label}</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">{$objRech.text_label_filtre}</label>
                                        ...
                                        {/if}
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">{$objRech.text_label}
    ...
    {if $bLabelCreationElem}
        {if ! $bFormPopup}
            ...
            <div>
                <a href="{$sLabelCreationElemUrl}" alt="{$sLabelCreationElem}">
                    <button type="button" class="btn vd_btn vd_bg-green" style="margin-top: 10px; margin-botton: 10px; margin-bottom: 10px;"><i class="fa fa-plus fa-fw"></i>{$sLabelCreationElem}</button>
                </a>
            </div>
            {/if}
        {else}
        ...
        {/if}
    {/if}
    <div class="no-print" style="margin-bottom:20px;;margin-top: 20px;"><b>{$iTabListeCount} {$sLabelNbrLigne}</b></div>
    {if $bAffListe}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel widget">
                    <div class="panel-heading vd_bg-grey" style="margin-bottom: 10px;">
                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>{$sTitreListe}</h3>
                    </div>
                    <div class="panel-body-list table-responsive" style="overflow-x:auto;">
                                ...
                                <tr>
                                    ...
                                    {foreach from=$aEnteteListe item=objEnteteListe}
                                        {if $objEnteteListe.objElement.type_champ!='hidden'}
                                            <th class="center" align="center">{$objEnteteListe.sLabel}</th>
                                        {/if}
                                    {/foreach}
