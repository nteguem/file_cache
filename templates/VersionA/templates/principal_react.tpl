<!doctype html><html lang="en"><head>
    ...
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.{slimInterpol}.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
...
<script src="https://unpkg.com/react@16.0.0/umd/react.production.min.{prInterpol}.js"></script>
