<!doctype html><html lang="en"><head>
    ...
    <?php  $manifest_1 = filemtime(PATH_ASSETS.'ReactCalendar/manifest.json');?>
    <link rel="manifest" href="ReactCalendar/manifest.<?php echo $manifest_1 ?>.json">
    <?php  $data_1 = filemtime(PATH_ASSETS.'data.json');?>
    <link rel="data" href="data.<?php echo $data_1 ?>.json">
