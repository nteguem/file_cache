					                ...
					                {elseif $objForm.type_champ eq 'select'}
										...
										<div class="form-group">
					                        ...
					                        <div class="col-sm-6 controls">
												...
												<?php $selectFormulaire = filemtime(PATH_ASSETS.'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css') ?>
												<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.<?php echo $selectFormulaire ?>.css" rel="stylesheet" />
							...
							<div class="form-group">
								...
								<div class="col-sm-6 controls">
									...
									{elseif $objForm.type_champ eq 'color'}
										...
										{literal}
											<script type="text/javascript">
												$("{/literal}#id_{$objForm.nom_variable}{literal}").siblings().css({'color' : '#5D9AD4'});
