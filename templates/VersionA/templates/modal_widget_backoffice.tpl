...
<head>
  ...
  <!-- Specific CSS -->
    ...
    <script type="text/javascript" src="js/jquery.mCustomScrollbar.concat.min.{$queryCustomScrollbar}.js"></script>
   ...
   <!-- Script pour l'auto-completion -->
    ...
    <script type="text/javascript" src="js/liste_widget_prise_rdv_backoffice.{$listeWidget}.js?{$stime}"></script>
