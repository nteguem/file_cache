...
<script type="text/javascript">
  ...
  function open_modal(){
    ...
    document.getElementById("iframerdv").src="modal/modal_standard.php?identifiant_user={/literal}{$identifiant_user}{literal}";
  ...
  function open_modal_update(idunique, idplage){
    ...
    document.getElementById("iframerdv").src="modal/modal_standard.php?identifiant_user={/literal}{$identifiant_user}{literal}&idunique="+idunique+"&idplage="+idplage;
    $('#iframerdv').css("overflow-y", "scroll");
    $('#myModalinfordv').modal('show');
  }
...
<div class="vd_title-section clearfix">
  ...
  <div class="col-sm-12">
    <button type="button"  class="btn vd_btn vd_bg-green" onclick="open_modal();">Ajouter une plage pour le standard</button>
  </div>
