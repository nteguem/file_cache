...
try {
    ...
    $jQryInputMaskPlanning->assign ('jQryInputMaskPlanning',filemtime('../js/jquery.inputmask.js'));
    $v->assign ('modernizr',filemtime('js/modernizr.js'));
    $mobileDetect->assign ('mobileDetect',filemtime('js/mobile-detect.min.js'));
    $mobileDetectModernizr->assign ('mobileDetectModernizr',filemtime('js/mobile-detect-modernizr.js'));
    $fullCalendar->assign ('fullCalendar',filemtime('plugins/fullcalendar-2.3.1/lib/jquery.min.js   '));
    $bootstrap->assign ('bootstrap',filemtime('js/bootstrap.min.js'));

    $jqueryUi->assign ('jqueryUi',filemtime('plugins/jquery-ui/jquery-ui.custom.min.js'));
    $jqueryUiTouch->assign ('jqueryUiTouch',filemtime('plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js'));
    $caroufredsel->assign ('caroufredsel',filemtime('js/caroufredsel.js'));
    $Plugin->assign ('Plugin',filemtime('js/plugins.js'));
    $framwork->assign ('framwork',filemtime('js/framwork_js.js'));
    $autocomplete->assign ('autocomplete',filemtime('js/jquery.autocomplete.min.js'));
    $breakpoints->assign ('breakpoints',filemtime('plugins/breakpoints/breakpoints.js'));
    $dataTables->assign ('dataTables',filemtime('plugins/dataTables/jquery.dataTables.min.js'));
    $prettyPhoto->assign ('prettyPhoto',filemtime('plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js'));
    $mCustomScrollbar->assign ('mCustomScrollbar',filemtime('plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js'));
    $tagsInput->assign ('tagsInput',filemtime('plugins/tagsInput/jquery.tagsinput.min.js'));
    $switch->assign ('switch',filemtime('plugins/bootstrap-switch/bootstrap-switch.min.js'));
    $blockUI->assign ('blockUI',filemtime('plugins/blockUI/jquery.blockUI.js'));
    $pnotify->assign ('pnotify',filemtime('plugins/pnotify/js/jquery.pnotify.min.js'));
    $theme->assign ('theme',filemtime('js/theme.js'));
    $custom->assign ('custom',filemtime('custom/custom.js'));
    $dataTables2->assign ('dataTables2',filemtime('plugins/dataTables/jquery.dataTables.min.js'));
    $dataTables3->assign ('dataTables3',filemtime('plugins/dataTables/dataTables.bootstrap.js'));
    $datepicker->assign ('datepicker',filemtime('js/datepicker-fr.js'));
    $timepicker->assign ('timepicker',filemtime('plugins/bootstrap-timepicker/bootstrap-timepicker.min.js'));
    $moment->assign ('moment',filemtime('plugins/daterangepicker/moment.min.js'));
    $daterangepicker->assign ('daterangepicker',filemtime('plugins/daterangepicker/daterangepicker.js'));
    $colorpicker->assign ('colorpicker',filemtime('plugins/colorpicker/colorpicker.js'));
    $loadImg->assign ('loadImg',filemtime('plugins/jquery-file-upload/js/load-image.min.js'));
    $transport->assign ('transport',filemtime('plugins/jquery-file-upload/js/jquery.iframe-transport.js'));
    $fileupload->assign ('fileupload',filemtime('plugins/jquery-file-upload/js/jquery.fileupload.js'));
    $process->assign ('process',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-process.js'));
    $image->assign ('image',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-image.js'));
    $audio->assign ('audio',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-audio.js'));
    $validate->assign ('validate',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-validate.js'));
    $moment2->assign ('moment2',filemtime('plugins/fullcalendar-2.3.1/lib/moment.min.js'));
    $fullCalendar->assign ('fullCalendar',filemtime('plugins/fullcalendar-2.3.1/fullcalendar.min.js'));
    $lang->assign ('lang',filemtime('plugins/fullcalendar-2.3.1/lang-all.js'));
    $ckeditor->assign ('ckeditor',filemtime('plugins/ckeditor/ckeditor.js'));
    $adapters->assign ('adapters',filemtime('plugins/ckeditor/adapters/jquery.js'));
    $maskedinput->assign ('maskedinput',filemtime('js/jquery.maskedinput.min.js'));
    $maskchamps->assign ('maskchamps',filemtime('js/maskchamps.js'));
    $jQuerryMin->assign ('jQuerryMin',filemtime('plugins/fullcalendar-3.5.0/lib/jquery.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapMin->assign ('bootstrapMin',filemtime('js/bootstrap.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryCustomMin->assign ('jQuerryCustomMin',filemtime('plugins/jquery-ui/jquery-ui.custom.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryUITouchPunchMin->assign ('jQuerryUITouchPunchMin',filemtime('jplugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $caroufredsel->assign ('caroufredsel',filemtime('js/caroufredsel.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $plugins->assign ('plugins',filemtime('js/plugins.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $framwork_js->assign ('framwork_js',filemtime('js/framwork_js.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryAutoCompleteMin->assign ('jQuerryAutoCompleteMin',filemtime('js/jquery.autocomplete.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $breakpoints->assign ('breakpoints',filemtime('plugins/breakpoints/breakpoints.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryDataTablesMin->assign ('jQuerryDataTablesMin',filemtime('plugins/dataTables/jquery.dataTables.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryPrettyPhoto->assign ('jQuerryPrettyPhoto',filemtime('plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerrymCustomScrollBarConcatMin->assign ('jQuerrymCustomScrollBarConcatMin',filemtime('plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryTagsInputMin->assign ('jQuerryTagsInputMin',filemtime('plugins/tagsInput/jquery.tagsinput.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapSwitchMin->assign ('bootstrapSwitchMin',filemtime('plugins/bootstrap-switch/bootstrap-switch.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryBlockUI->assign ('jQuerryBlockUI',filemtime('plugins/blockUI/jquery.blockUI.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryPnotifyMin->assign ('jQuerryPnotifyMin',filemtime('plugins/pnotify/js/jquery.pnotify.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $datepicker->assign ('datepicker',filemtime('js/datepicker.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $datepickerFr->assign ('datepickerFr',filemtime('js/datepicker-fr.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $theme->assign ('theme',filemtime('js/theme.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $custom->assign ('custom',filemtime('custom/custom.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryBootstrapWizardMin->assign ('jQuerryBootstrapWizardMin',filemtime('plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryDataTablesMin->assign ('jQuerryDataTablesMin',filemtime('plugins/dataTables/jquery.dataTables.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $dataTablebootstrap->assign ('dataTablebootstrap',filemtime('plugins/dataTables/dataTables.bootstrap.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapTimePickerMin->assign ('bootstrapTimePickerMin',filemtime('plugins/bootstrap-timepicker/bootstrap-timepicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $momentMin->assign ('momentMin',filemtime('js/moment.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $daterangepicker->assign ('daterangepicker',filemtime('js/daterangepicker.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $colorpicker->assign ('colorpicker',filemtime('plugins/colorpicker/colorpicker.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $loadImagMin->assign ('loadImagMin',filemtime('plugins/jquery-file-upload/js/load-image.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryIframeTransport->assign ('jQuerryIframeTransport',filemtime('plugins/jquery-file-upload/js/jquery.iframe-transport.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryFileUpload->assign ('jQuerryFileUpload',filemtime('plugins/jquery-file-upload/js/jquery.fileupload.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryFileUploadProcess->assign ('jQuerryFileUploadProcess',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-process.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryFileUploadImage->assign ('jQuerryFileUploadImage',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-image.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryFileUploadAudio->assign ('jQuerryFileUploadAudio',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-audio.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryFileUploadValidate->assign ('jQuerryFileUploadValidate',filemtime('plugins/jquery-file-upload/js/jquery.fileupload-validate.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryUiMin->assign ('jQuerryUiMin',filemtime('plugins/fullcalendar-3.5.0/lib/jquery-ui.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $momentMin2->assign ('momentMin2',filemtime('plugins/fullcalendar-3.5.0/lib/moment.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $fullCalendarMin->assign ('fullCalendarMin',filemtime('plugins/fullcalendar-3.5.0/fullcalendar.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $fr->assign ('fr',filemtime('plugins/fullcalendar-3.5.0/locale/fr.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $schedulerMin->assign ('schedulerMin',filemtime('plugins/fullcalendar-3.5.0/scheduler.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $ckeditor->assign ('ckeditor',filemtime('plugins/ckeditor/ckeditor.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jquery3->assign ('jquery3',filemtime('plugins/ckeditor/adapters/jquery.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jqueryMaskedInputMin->assign ('jqueryMaskedInputMin',filemtime('js/jquery.maskedinput.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $maskchamps->assign ('maskchamps',filemtime('js/maskchamps.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapClockPickerMin->assign ('bootstrapClockPickerMin',filemtime('js/bootstrap-clockpicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryClockPickerMin->assign ('jQuerryClockPickerMin',filemtime('js/jquery-clockpicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $isotopKgdMin->assign ('isotopKgdMin',filemtime('js/isotope.pkgd.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $inputMask->assign ('inputMask',filemtime('js/inputmask.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryInputMask->assign ('jQuerryInputMaskmain',filemtime('js/jquery.inputmask.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $intlTelInput->assign ('intlTelInput',filemtime('js/intlTelInput.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $principal->assign ('principal',filemtime('js/principal.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $mdp->assign ('mdp',filemtime('js/mdp.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $fonctionAdv->assign ('fonctionAdv',filemtime('js/fonction_adv.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $modernizr->assign ('modernizr',filemtime('js/modernizr.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $mobileDetectMin->assign ('mobileDetectMin',filemtime('js/mobile-detect.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $mobileDetectModernizr->assign ('mobileDetectModernizr',filemtime('js/mobile-detect-modernizr.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryMin->assign ('jQuerryMin',filemtime('plugins/fullcalendar-3.5.0/lib/jquery.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapMin->assign ('bootstrapMin',filemtime('js/bootstrap.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryUICustomMin->assign ('jQuerryUICustomMin',filemtime('plugins/jquery-ui/jquery-ui.custom.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryUITouchPunchMin->assign ('jQuerryUITouchPunchMin',filemtime('plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $caroufredsel->assign ('caroufredsel',filemtime('js/caroufredsel.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $plugins->assign ('plugins',filemtime('js/plugins.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $framwork_js->assign ('framwork_js',filemtime('js/framwork_js.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryAutoCompleteMin->assign ('jQuerryAutoCompleteMin',filemtime('js/jquery.autocomplete.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    ...
    $jQuerryPrettyPhoto->assign ('jQuerryPrettyPhoto',filemtime('plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerrymCustomScrollBarConcatMin->assign ('jQuerrymCustomScrollBarConcatMin',filemtime('plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryTargsInputMin->assign ('jQuerryTargsInputMin',filemtime('plugins/tagsInput/jquery.tagsinput.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapSwitchMin->assign ('bootstrapSwitchMin',filemtime('plugins/bootstrap-switch/bootstrap-switch.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryBlockUI->assign ('jQuerryBlockUI',filemtime('plugins/blockUI/jquery.blockUI.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $datepicker->assign ('datepicker',filemtime('js/datepicker.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $datepickerFr->assign ('datepickerFr',filemtime('js/datepicker-fr.js?v={/literal}{$numero_version_alaxione}{literal}'));
    ...
    $custom->assign ('custom',filemtime('custom/custom.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryBootstrapWizardMin->assign ('jQuerryBootstrapWizardMin',filemtime('plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryDataTablesMin2->assign ('jQuerryDataTablesMin2',filemtime('plugins/dataTables/jquery.dataTables.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $dataTablebootstrap->assign ('dataTablebootstrap',filemtime('plugins/dataTables/dataTables.bootstrap.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapTimePickerMin->assign ('bootstrapTimePickerMin',filemtime('plugins/bootstrap-timepicker/bootstrap-timepicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $momentMin->assign ('momentMin',filemtime('js/moment.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $daterangepicker->assign ('daterangepicker',filemtime('js/daterangepicker.js?v={/literal}{$numero_version_alaxione}{literal}'));
    ...
    $schedulerMin->assign ('schedulerMin',filemtime('plugins/fullcalendar-3.5.0/scheduler.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $ckeditor->assign ('ckeditor',filemtime('plugins/ckeditor/ckeditor.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerry2->assign ('jQuerry2',filemtime('plugins/ckeditor/adapters/jquery.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryMaskedInputMin->assign ('jQuerryMaskedInputMin',filemtime('js/jquery.maskedinput.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $maskchamps->assign ('maskchamps',filemtime('js/maskchamps.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $bootstrapClockPickerMin->assign ('bootstrapClockPickerMin',filemtime('js/bootstrap-clockpicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryClockPickerMin->assign ('jQuerryClockPickerMin',filemtime('js/jquery-clockpicker.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $isotopKgd->assign ('isotopKgd',filemtime('js/isotope.pkgd.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $inputMask->assign ('inputMask',filemtime('js/inputmask.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryInputMask->assign ('jQuerryInputMask',filemtime('js/jquery.inputmask.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $intlTelInputMin->assign ('intlTelInputMin',filemtime('js/intlTelInput.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $principal->assign ('principal',filemtime('js/principal.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $functionRdvExist->assign ('functionRdvExist',filemtime('js/function_rdv_exist.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $mdp->assign ('mdp',filemtime('js/mdp.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $functionAdv->assign ('functionAdv',filemtime('js/fonction_adv.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jQuerryPnotifyMin->assign ('jQuerryPnotifyMin',filemtime('plugins/pnotify/js/jquery.pnotify.min.js?v={/literal}{$numero_version_alaxione}{literal}'));
    $jquery->assign ('jquery',filemtime('plugins/fullcalendar-2.3.1/lib/jquery.min.js'));
    $modernizr->assign ('modernizr',filemtime('js/modernizr.js'));
    $mobileDetect->assign ('mobileDetect',filemtime('js/mobile-detect.min.js'));
    $mobileDetectModernizr->assign ('mobileDetectModernizr',filemtime('js/mobile-detect-modernizr.js'));
    $bootstrap->assign ('bootstrap',filemtime('js/bootstrap.min.js'));
    $jqueryCustom->assign ('jqueryCustom',filemtime('plugins/jquery-ui/jquery-ui.custom.min.js'));
    $jqueryTouch->assign ('jqueryTouch',filemtime('plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js'));
    $caroufredsel->assign ('caroufredsel',filemtime('js/caroufredsel.js'));
    $plugin->assign ('plugin',filemtime('js/plugins.js'));
    $framwork->assign ('framwork',filemtime('js/framwork_js.js'));
    $autocomplete->assign ('autocomplete',filemtime('js/jquery.autocomplete.min.js'));
    $breakpoints->assign ('breakpoints',filemtime('plugins/breakpoints/breakpoints.js'));
    $dataTables->assign ('dataTables',filemtime('plugins/dataTables/jquery.dataTables.min.<?php echo $dataTables ?>.js'));
    $prettyPhoto->assign ('prettyPhoto',filemtime('plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js'));
    $mCustomScrollbar->assign ('mCustomScrollbar',filemtime('plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js'));
    $tagsInput->assign ('tagsInput',filemtime('plugins/tagsInput/jquery.tagsinput.min.js'));
    $switch->assign ('switch',filemtime('plugins/bootstrap-switch/bootstrap-switch.min.js'));
    ...
    $mobileDetectModernizr->assign ('mobileDetectModernizr',filemtime('js/mobile-detect-modernizr.js'));
    $bootstrap->assign ('bootstrap',filemtime('js/bootstrap.min.js'));
    $jquery->assign ('jquery',filemtime('plugins/jquery-ui/jquery-ui.custom.min.js'));
    $jqueryTouch->assign ('jqueryTouch',filemtime('plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js'));
    $caroufredsel->assign ('caroufredsel',filemtime('js/caroufredsel.js'));
    $plugin->assign ('plugin',filemtime('js/plugins.js'));
    $framwork->assign ('framwork',filemtime('js/framwork_js.js'));
    ...
    $mobileDetect->assign ('mobileDetect',filemtime('js/mobile-detect.min.js'));
    $mobileDetectModernizr->assign ('mobileDetectModernizr',filemtime('js/mobile-detect-modernizr.js'));
    $jquery->assign ('jquery',filemtime('js/jquery.js'));
    $bootstrap->assign ('bootstrap',filemtime('js/bootstrap.min.js'));
    $jqueryCustom->assign ('jqueryCustom',filemtime('plugins/jquery-ui/jquery-ui.custom.min.js'));
    $jqueryTouch->assign ('jqueryTouch',filemtime('plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js'));
    $caroufredsel->assign ('caroufredsel',filemtime('js/caroufredsel.js'));
